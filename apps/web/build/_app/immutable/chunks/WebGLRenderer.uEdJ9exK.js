...
import { S as F, b as q } from './colorToUniform.DmtBy-2V.js';
import {
  e as Ge,
  G as Ue,
  c as Fe,
  ...
  S as He,
  a as we,
} from './SharedSystems.B84qRToq.js';
class Q {
  constructor() {
...
Q.extension = { type: [d.WebGLPipesAdaptor], name: 'batch' };
var x = ((t) => (
...
class J {
  ...
  freeLocationForBufferBase(e) {
    ...
    return (
      ...
      s >= 2 ? -1 : ((e._lastBindCallId = this._bindCallId), (this._boundBufferBases[r] = null), r)
    );
  }
  ...
  bindBufferRange(e, r, s, n) {
    ...
    (s || (s = 0),
      ...
      i.bindBufferRange(i.UNIFORM_BUFFER, r || 0, e.buffer, s * 256, n || 256));
  }
  updateBuffer(e) {
    const { _gl: r } = this,
      s = this.getGlBuffer(e);
    ...
    const n = e.data,
      i = e.descriptor.usage & A.STATIC ? r.STATIC_DRAW : r.DYNAMIC_DRAW;
    return (
      n
        ...
        : ((s.byteLength = e.descriptor.size), r.bufferData(s.type, s.byteLength, i)),
      s
    );
  }
  destroyAll() {
  ...
  createGLBuffer(e) {
    ...
    e.descriptor.usage & A.INDEX
      ? (s = x.ELEMENT_ARRAY_BUFFER)
      : e.descriptor.usage & A.UNIFORM && (s = x.UNIFORM_BUFFER);
...
J.extension = { type: [d.WebGLSystem], name: 'buffer' };
const O = class ee {
  constructor(e) {
    ((this.supports = {
      uint32Indices: !0,
  ...
  init(e) {
    ...
    if (
      (e.context &&
        ...
        (r = !1)),
      r
        ? (this.canvas = S.get().createCanvas(
  ...
  initFromContext(e) {
    ((this.gl = e),
      (this.webGLVersion = e instanceof S.get().getWebGLRenderingContext() ? 1 : 2),
      this.getExtensions(),
  ...
  validateContext(e) {
    ...
    r &&
      !r.stencil &&
      m('Provided WebGL context does not have a stencil buffer, masks may not render correctly');
...
O.extension = { type: [d.WebGLSystem], name: 'context' };
O.defaultOptions = {
  context: null,
...
class re {
  ...
  onGeometryDestroy(e, r) {
    ...
    if (s) {
      if (r)
        for (const i in s) (this._activeVao !== s[i] && this.unbind(), n.deleteVertexArray(s[i]));
      ...
      if (h) {
        ...
        if (
          (h.format?.substring(1, 4) === 'int'
            ? s.vertexAttribIPointer(l, E.size, M, c.stride, c.offset)
            : s.vertexAttribPointer(l, E.size, M, E.normalised, c.stride, c.offset),
          c.instance)
        )
          if (this.hasInstance) {
  ...
  draw(e, r, s, n) {
    ...
    if ((n ?? (n = a.instanceCount), a.indexBuffer)) {
      ...
      n > 1
        ? i.drawElementsInstanced(o, r || a.indexBuffer.data.length, u, (s || 0) * c, n)
...
re.extension = { type: [d.WebGLSystem], name: 'geometry' };
const je = new Ae({ attributes: { aPosition: [-1, -1, 3, -1, -1, 3] } }),
  P = class se {
    constructor(e) {
    ...
    init(e = {}) {
      ...
      ((this.useBackBuffer = r),
        ...
        this._renderer.context.supports.msaa ||
          (m('antialiasing, is not supported on when using the back buffer'),
          (this._antialias = !1)),
        (this._state = F.for2d()));
      const n = new Be({
        vertex: `
      ...
      this._bigTriangleShader = new G({ glProgram: n, resources: { uTexture: b.WHITE.source } });
    }
    renderStart(e) {
    ...
    _presentBackBuffer() {
      ...
      (e.renderTarget.finishRenderPass(),
        this._useBackBufferThisRender &&
          ...
          e.encoder.draw({ geometry: je, shader: this._bigTriangleShader, state: this._state })));
    }
...
P.extension = { type: [d.WebGLSystem], name: 'backBuffer', priority: 1 };
...
ne.extension = { type: [d.WebGLSystem], name: 'colorMask' };
class ie {
  constructor(e) {
...
ie.extension = { type: [d.WebGLSystem], name: 'encoder' };
class ae {
  constructor(e) {
    this._renderer = e;
  }
  contextChange() {
    ...
    ((this.maxTextures = e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS)),
      (this.maxBatchableTextures = Ne(this.maxTextures, e)),
      (this.maxUniformBindings = e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS)));
  }
  destroy() {}
}
ae.extension = { type: [d.WebGLSystem], name: 'limits' };
class $e {
  constructor() {
...
class oe {
  constructor(e) {
    ((this._stencilCache = { enabled: !1, stencilReference: 0, stencilMode: p.NONE }),
  ...
  setStencilMode(e, r) {
    ...
    (this._stencilCache.enabled || ((this._stencilCache.enabled = !0), n.enable(n.STENCIL_TEST)),
      (e !== a.stencilMode || a.stencilReference !== r) &&
        ((a.stencilMode = e),
        (a.stencilReference = r),
        n.stencilFunc(this._comparisonFuncMapping[i.stencilBack.compare], r, 255),
        n.stencilOp(n.KEEP, n.KEEP, this._stencilOpsMapping[i.stencilBack.passOp])));
  }
}
oe.extension = { type: [d.WebGLSystem], name: 'stencil' };
const ce = {
  f32: 4,
  i32: 4,
  'vec2<f32>': 8,
...
function Ye(t, e) {
  const r = Math.max(ce[t.data.type] / 16, 1),
    s = t.data.value.length / t.data.size,
    n = (4 - (s % 4)) % 4,
    i = t.data.type.indexOf('i32') >= 0 ? 'dataInt32' : 'data';
  return `
        v = uv.${t.data.name};
        offset += ${e};
...
function qe(t) {
  return Fe(t, 'uboStd40', Ye, Oe);
}
class ue extends Pe {
  constructor() {
    super({ createUboElements: ze, generateUboSync: qe });
  }
}
ue.extension = { type: [d.WebGLSystem], name: 'ubo' };
class Ze {
  constructor() {
  ...
  copyToTexture(e, r, s, n, i) {
    ...
    return (
      ...
      o.texture.bind(r, 0),
      u.copyTexSubImage2D(u.TEXTURE_2D, 0, i.x, i.y, s.x, s.y, n.width, n.height),
      r
    );
  }
  startRenderPass(e, r = !0, s, n) {
    ...
    ((_.x !== n.x || _.y !== c || _.width !== n.width || _.height !== n.height) &&
      ((_.x = n.x),
      (_.y = c),
      (_.width = n.width),
      (_.height = n.height),
  ...
  initGpuRenderTarget(e) {
    const s = this._renderer.gl,
      n = new $e();
    return e.colorTexture instanceof T
      ...
      e.colorTextures.forEach((a, o) => {
        ...
        (c.antialias &&
          (s.context.supports.msaa
            ? (r.msaa = !0)
            : m('[RenderTexture] Antialiasing on textures is not supported in WebGL1')),
      ...
      (i.bindFramebuffer(i.FRAMEBUFFER, a),
        e.colorTextures.forEach((o, c) => {
          ...
          const h = n.texture.getGlSource(u).internalFormat,
            l = r.msaaRenderBuffer[c];
          (i.bindRenderbuffer(i.RENDERBUFFER, l),
            i.renderbufferStorageMultisample(i.RENDERBUFFER, 4, h, u.pixelWidth, u.pixelHeight),
            i.framebufferRenderbuffer(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0 + c, i.RENDERBUFFER, l));
        }));
    }
  }
  _initStencil(e) {
    ...
    ((e.depthStencilRenderBuffer = s),
      ...
      r.framebufferRenderbuffer(r.FRAMEBUFFER, r.DEPTH_STENCIL_ATTACHMENT, r.RENDERBUFFER, s),
  ...
  prerender(e) {
    ...
    this._renderer.context.multiView && T.test(r) && this._renderer.context.ensureCanvasSize(r);
  }
  postrender(e) {
    if (this._renderer.context.multiView && T.test(e.colorTexture.resource)) {
...
_e.extension = { type: [d.WebGLSystem], name: 'renderTarget' };
function Qe(t, e) {
  const r = [],
    s = [
      `
...
function rt(t, e, r = !1) {
  ...
  for (let a = 0; a < n; a++) {
    ...
    const c = tt(e, o.type);
    s[o.name] = { location: 0, format: c, stride: $(c).stride, offset: 0, instance: !1, start: 0 };
  }
...
function nt(t, e) {
  ...
  for (let n = 0; n < s; n++) {
    const i = e.getActiveUniform(t, n),
      ...
      o = !!i.name.match(/\[.*?\]$/),
      c = he(e, i.type);
    r[a] = { name: a, index: n, type: c, size: i.size, isArray: o, value: fe(c, i.size) };
  }
  return r;
}
function k(t, e) {
...
function it(t, e, r, s) {
  t.getProgramParameter(e, t.LINK_STATUS) ||
    (t.getShaderParameter(r, t.COMPILE_STATUS) || k(t, r),
    t.getShaderParameter(s, t.COMPILE_STATUS) || k(t, s),
    console.error('PixiJS Error: Could not initialize shader.'),
    t.getProgramInfoLog(e) !== '' &&
      console.warn('PixiJS Warning: gl.getProgramInfoLog()', t.getProgramInfoLog(e)));
}
function at(t, e) {
  const r = w(t, t.VERTEX_SHADER, e.vertex),
    s = w(t, t.FRAGMENT_SHADER, e.fragment),
    n = t.createProgram();
  (t.attachShader(n, r), t.attachShader(n, s));
  const i = e.transformFeedbackVaryings;
  (i &&
    (typeof t.transformFeedbackVaryings != 'function'
      ? m('TransformFeedback is not supported but TransformFeedbackVaryings are given.')
    ...
    t.linkProgram(n),
    t.getProgramParameter(n, t.LINK_STATUS) || it(t, n, r, s),
    (e._attributeData = rt(n, t, !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(e.vertex))),
    (e._uniformData = nt(n, t)),
  ...
  for (const c in e._uniformData) {
    ...
    a[c] = { location: t.getUniformLocation(n, c), value: fe(u.type, u.size) };
  }
  return new Je(n, a);
}
...
class le {
  ...
  bind(e, r) {
    ...
    (s || (s = this._shaderSyncFunctions[e.glProgram._key] = this._generateShaderSync(e, this)),
  ...
  bindUniformBlock(e, r, s = 0) {
    ...
    const o = e.buffer,
      c = n.updateBuffer(o),
      u = n.freeLocationForBufferBase(c);
    if (a) {
    ...
    i.uniformBlockBindings[s] !== u &&
      ((i.uniformBlockBindings[s] = u), this._renderer.gl.uniformBlockBinding(i.program, _, u));
  }
  _setProgram(e) {
...
le.extension = { type: [d.WebGLSystem], name: 'shader' };
const ot = {
    f32: `if (cv !== v) {
            cu.value = v;
...
class de {
  ...
  updateUniformGroup(e, r, s) {
    ...
    (!e.isStatic || e._dirtyId !== n.uniformDirtyGroups[e.uid]) &&
      ...
      this._getUniformSyncFunction(e, r)(n.uniformData, e.uniforms, this._renderer, s));
  }
  _getUniformSyncFunction(e, r) {
    return (
      this._uniformGroupSyncHash[e._signature]?.[r._key] || this._createUniformSyncFunction(e, r)
    );
  }
  _createUniformSyncFunction(e, r) {
    const s =
        this._uniformGroupSyncHash[e._signature] || (this._uniformGroupSyncHash[e._signature] = {}),
      n = this._getSignature(e, r._uniformData, 'u');
    return (
      this._cache[n] || (this._cache[n] = this._generateUniformsSync(e, r._uniformData)),
...
de.extension = { type: [d.WebGLSystem], name: 'uniformGroup' };
function _t(t) {
  const e = {};
  if (
    ...
    !(t instanceof S.get().getWebGLRenderingContext()))
  )
  ...
  me = class I {
    constructor(e) {
      ((this._invertFrontFace = !1),
        ...
        (this._blendEq = !1),
        (this.map = []),
        (this.map[ft] = this.setBlend),
        (this.map[ht] = this.setOffset),
        (this.map[lt] = this.setCullFace),
        (this.map[dt] = this.setDepthTest),
        (this.map[mt] = this.setFrontFace),
        (this.map[Et] = this.setDepthMask),
        (this.checks = []),
        (this.defaultState = F.for2d()),
        e.renderTarget.onRenderTargetChange.add(this));
    }
    onRenderTargetChange(e) {
    ...
    setBlendMode(e) {
      ...
      const r = this.blendModesMap[e],
        s = this.gl;
      (r.length === 2 ? s.blendFunc(r[0], r[1]) : s.blendFuncSeparate(r[0], r[1], r[2], r[3]),
        r.length === 6
          ? ((this._blendEq = !0), s.blendEquationSeparate(r[4], r[5]))
          : this._blendEq &&
            ((this._blendEq = !1), s.blendEquationSeparate(s.FUNC_ADD, s.FUNC_ADD)));
    }
...
me.extension = { type: [d.WebGLSystem], name: 'state' };
let bt = me;
class St {
  constructor(e) {
...
const pt = {
    ...
    upload(t, e, r) {
      (e.width === t.width || e.height === t.height
        ? r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, t.width, t.height, e.format, e.type, t.resource)
        : r.texImage2D(
            e.target,
            0,
            e.internalFormat,
  ...
  Rt = {
    ...
    upload(t, e, r) {
      ...
      for (let a = 0; a < t.resource.length; a++) {
        ...
        (i
          ? r.compressedTexImage2D(r.TEXTURE_2D, a, e.internalFormat, s, n, 0, o)
          : r.texImage2D(r.TEXTURE_2D, a, e.internalFormat, s, n, 0, e.format, e.type, o),
          (s = Math.max(s >> 1, 1)),
          (n = Math.max(n >> 1, 1)));
      }
    },
  ...
  Ee = {
    ...
    upload(t, e, r, s) {
      ...
      (c < a || u < o
        ? ((n !== a || i !== o) &&
            r.texImage2D(e.target, 0, e.internalFormat, a, o, 0, e.format, e.type, null),
          s === 2
            ? r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, c, u, e.format, e.type, t.resource)
            : r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, e.format, e.type, t.resource))
        : n === a && i === o
          ? r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, e.format, e.type, t.resource)
          : s === 2
            ? r.texImage2D(e.target, 0, e.internalFormat, a, o, 0, e.format, e.type, t.resource)
            : r.texImage2D(e.target, 0, e.internalFormat, e.format, e.type, t.resource),
        (e.width = a),
        (e.height = o));
    },
  },
  ...
  X = { linear: 9729, nearest: 9728 },
  vt = { linear: { linear: 9987, nearest: 9985 }, nearest: { linear: 9986, nearest: 9984 } },
  C = { 'clamp-to-edge': 33071, repeat: 10497, 'mirror-repeat': 33648 },
  Tt = {
    never: 512,
    less: 513,
    equal: 514,
...
function W(t, e, r, s, n, i, a, o) {
  ...
  if (
    ...
    const u = C[a ? 'clamp-to-edge' : t.addressModeU],
      _ = C[a ? 'clamp-to-edge' : t.addressModeV],
      h = C[a ? 'clamp-to-edge' : t.addressModeW];
...
function At(t, e) {
  ...
  return (
    t instanceof S.get().getWebGLRenderingContext()
      ...
      : ((r = { 'rgba8unorm-srgb': t.SRGB8_ALPHA8, 'bgra8unorm-srgb': t.SRGB8_ALPHA8 }),
        (s = t.RGBA8)),
    {
      r8unorm: t.R8,
      r8snorm: t.R8_SNORM,
...
class be {
  constructor(e) {
    ((this.managedTextures = []),
      ...
      (this._uploads = { image: Ee, buffer: pt, video: xt, compressed: Rt }),
  ...
  contextChange(e) {
    ((this._gl = e),
      this._mapFormatToInternalFormat ||
        ((this._mapFormatToInternalFormat = At(e, this._renderer.context.extensions)),
        (this._mapFormatToType = Nt(e)),
        (this._mapFormatToFormat = Bt(e))),
      (this._glTextures = Object.create(null)),
      (this._glSamplers = Object.create(null)),
      (this._boundSamplers = Object.create(null)),
      (this._premultiplyAlpha = !1));
  ...
  bind(e, r = 0) {
    const s = e.source;
    e
      ? (this.bindSource(s, r), this._useSeparateSamplers && this._bindSampler(s.style, r))
  ...
  onSourceUpdate(e) {
    ...
    (this._premultiplyAlpha !== n &&
      ((this._premultiplyAlpha = n), r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL, n)),
      this._uploads[e.uploadMethodId]
        ? this._uploads[e.uploadMethodId].upload(e, s, r, this._renderer.context.webGLVersion)
        : r.texImage2D(
            r.TEXTURE_2D,
            0,
            r.RGBA,
  ...
  getPixels(e) {
    ...
    return (
      ...
      _.readPixels(Math.round(s.x * r), Math.round(s.y * r), n, i, _.RGBA, _.UNSIGNED_BYTE, a),
  ...
  resetState() {
    ((this._activeTextureLocation = -1),
      this._boundTextures.fill(b.EMPTY.source),
      (this._boundSamplers = Object.create(null)));
    const e = this._gl;
    ((this._premultiplyAlpha = !1),
...
be.extension = { type: [d.WebGLSystem], name: 'texture' };
class Se {
  contextChange(e) {
    const r = new U({
      ...
      n = z({ name: 'graphics', bits: [ye, Ce(s), q, Y] });
    this.shader = new G({ glProgram: n, resources: { localUniforms: r, batchSamplers: De(s) } });
  }
  execute(e, r) {
    const s = r.context,
    ...
    ((n.groups[0] = i.globalUniforms.bindGroup),
      i.state.set(e.state),
      i.shader.bind(n),
      i.geometry.bind(o.geometry, n.glProgram));
...
Se.extension = { type: [d.WebGLPipesAdaptor], name: 'graphics' };
class pe {
  init() {
    const e = z({ name: 'mesh', bits: [q, Le, Y] });
    this._shader = new G({
      glProgram: e,
      resources: {
        uTexture: b.EMPTY.source,
        textureUniforms: { uTextureMatrix: { type: 'mat3x3<f32>', value: new K() } },
      },
    });
  }
  execute(e, r) {
    ...
    if (n) {
      ...
      ((n.resources.uTexture = a),
        ...
        (n.resources.textureUniforms.uniforms.uTextureMatrix = i.textureMatrix.mapCoord));
    }
...
pe.extension = { type: [d.WebGLPipesAdaptor], name: 'mesh' };
const Ct = [...He, ue, Ke, ke, ae, J, be, _e, re, de, le, ie, bt, oe, ne],
  Dt = [...we],
  It = [Q, pe, Se],
  ge = [],
  Re = [],
  xe = [];
v.handleByNamedList(d.WebGLSystem, ge);
v.handleByNamedList(d.WebGLPipes, Re);
