import {
  ...
  o as A,
  V as Be,
} from './index.422b0410.js';
import { g as Ee } from './_commonjsHelpers.725317a4.js';
import { g as Ve } from './getTextureBatchBindGroup.b7e5a7d4.js';
import { D as je } from './DefaultBatcher.447e3813.js';
function Qt(s, t, e = 2) {
  const n = t && t.length,
    i = n ? t[0] * e : s.length;
  let r = me(s, 0, i, e, !0);
  ...
  let a, c, l;
  if ((n && (r = Ze(s, t, r, e)), s.length > 80 * e)) {
    ((a = s[0]), (c = s[1]));
    let h = a,
      d = c;
    for (let f = e; f < i; f += e) {
      const u = s[f],
        x = s[f + 1];
      (u < a && (a = u), x < c && (c = x), u > h && (h = u), x > d && (d = x));
    }
    ((l = Math.max(h - a, d - c)), (l = l !== 0 ? 32767 / l : 0));
  }
  return (ft(r, o, e, a, c, l, 0), o);
}
function me(s, t, e, n, i) {
  ...
  return (r && tt(r, r.next) && (yt(r), (r = r.next)), r);
}
function K(s, t) {
  if (!s) return s;
  t || (t = s);
  let e = s,
    n;
  do
    if (((n = !1), !e.steiner && (tt(e, e.next) || z(e.prev, e, e.next) === 0))) {
...
function ft(s, t, e, n, i, r, o) {
  ...
  for (; s.prev !== s.next; ) {
    const c = s.prev,
      l = s.next;
    if (r ? Ne(s, n, i, r) : We(s)) {
      (t.push(c.i, s.i, l.i), yt(s), (s = l.next), (a = l.next));
      continue;
    }
    if (((s = l), s === a)) {
      o
        ? o === 1
          ? ((s = $e(K(s), t)), ft(s, t, e, n, i, r, 2))
          : o === 2 && Ue(s, t, e, n, i, r)
        : ft(K(s), t, e, n, i, r, 1);
      break;
    }
...
function Ue(s, t, e, n, i, r) {
  ...
  do {
    ...
    for (; a !== o.prev; ) {
      if (o.i !== a.i && en(o, a)) {
        let c = Pe(o, a);
        ((o = K(o, o.next)), (c = K(c, c.next)), ft(o, t, e, n, i, r, 0), ft(c, t, e, n, i, r, 0));
        return;
      }
      a = a.next;
    }
...
function Ze(s, t, e, n) {
  ...
  for (let r = 0, o = t.length; r < o; r++) {
    const a = t[r] * n,
      c = r < o - 1 ? t[r + 1] * n : s.length,
      l = me(s, a, c, n, !1);
    (l === l.next && (l.steiner = !0), i.push(tn(l)));
  }
  i.sort(Xe);
  for (let r = 0; r < i.length; r++) e = Ye(i[r], e);
  return e;
}
function Xe(s, t) {
  let e = s.x - t.x;
...
function Qe(s, t) {
  ...
  do {
    if (
      ...
      e.x >= c &&
      n !== e.x &&
      _e(i < l ? n : r, i, c, l, i < l ? r : n, i, e.x, e.y)
    ) {
      const d = Math.abs(i - e.y) / (n - e.x);
      xt(e, s) &&
        (d < h || (d === h && (e.x > o.x || (e.x === o.x && Ke(o, e))))) &&
        ((o = e), (h = d));
    }
    e = e.next;
  } while (e !== a);
...
function Oe(s, t, e, n) {
  ...
  do
    (i.z === 0 && (i.z = It(i.x, i.y, t, e, n)),
      ...
      (i = i.next));
  while (i !== s);
  ((i.prevZ.nextZ = null), (i.prevZ = null), Je(i));
}
function Je(s) {
  let t,
    e = 1;
...
function ht(s, t, e, n, i, r, o, a) {
  return !(s === o && t === a) && _e(s, t, e, n, i, r, o, a);
}
function en(s, t) {
  return (
    s.next.i !== t.i &&
    s.prev.i !== t.i &&
    !nn(s, t) &&
    ((xt(s, t) && xt(t, s) && sn(s, t) && (z(s.prev, s, t.prev) || z(s, t.prev, t))) ||
      (tt(s, t) && z(s.prev, s, s.next) > 0 && z(t.prev, t, t.next) > 0))
  );
}
function z(s, t, e) {
...
function nn(s, t) {
  let e = s;
  do {
    if (e.i !== s.i && e.next.i !== s.i && e.i !== t.i && e.next.i !== t.i && be(e, e.next, s, t))
      return !0;
    e = e.next;
  } while (e !== s);
  return !1;
...
const on = Qt.default || Qt,
  ...
  Bt = class zt {
    ...
    buildLinearGradient() {
      ...
      const c = this.colorStops.length ? this.colorStops : Ot,
        l = this._textureSize,
        { canvas: h, context: d } = te(l, 1),
        f = a
      ...
      (Jt(f, c),
        (d.fillStyle = f),
        d.fillRect(0, 0, l, 1),
        (this.texture = new Q({ source: new Yt({ resource: h, addressMode: this._wrapMode }) })));
    ...
    buildRadialGradient() {
      if (this.texture) return;
      const t = this.colorStops.length ? this.colorStops : Ot,
        e = this._textureSize,
        { canvas: n, context: i } = te(e, e),
        { x: r, y: o } = this.center,
        { x: a, y: c } = this.outerCenter,
        l = this.innerRadius,
        h = this.outerRadius,
        d = a - h,
        f = c - h,
        ...
        x = (r - d) * u,
        y = (o - f) * u,
        p = i.createRadialGradient(x, y, l * u, (a - d) * u, (c - f) * u, h * u);
      (Jt(p, t),
        ...
        i.translate(-x, -y),
        i.fillRect(0, 0, e, e),
        (this.texture = new Q({ source: new Yt({ resource: n, addressMode: this._wrapMode }) })));
      const _ = new B();
      (_.scale(1 / u, 1 / u),
        _.translate(d, f),
...
function an(s) {
  ...
  return (
    (typeof t == 'number' || s[1]) &&
      (L('8.5.2', 'use options object instead'),
      (t = {
        type: 'linear',
        start: { x: s[0], y: s[1] },
        end: { x: s[2], y: s[3] },
...
class hn {
  constructor(t, e) {
    ((this.uid = Ct('fillPattern')),
      (this._tick = 0),
      (this.transform = new B()),
      (this.texture = t),
      this.transform.scale(1 / t.frame.width, 1 / t.frame.height),
      e &&
        ((t.source.style.addressModeU = ee[e].addressModeU),
        (t.source.style.addressModeV = ee[e].addressModeV)));
  }
  setTransform(t) {
...
var cn = un,
  Rt = { a: 7, c: 6, h: 1, l: 2, m: 2, q: 4, s: 4, t: 2, v: 1, z: 0 },
  ...
  return (
    s.replace(ln, function (e, n, i) {
      ...
      for (
        ...
        if (i.length == Rt[r]) return (i.unshift(n), t.push(i));
        if (i.length < Rt[r]) throw new Error('malformed path data');
        t.push([n].concat(i.splice(0, Rt[r])));
      }
    }),
    t
  );
}
var dn = /-?[0-9]*\.?[0-9]+(?:e[-+]?\d+)?/gi;
function fn(s) {
  var t = s.match(dn);
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    switch (l) {
      ...
      case 'C':
        ...
        break;
      case 'c':
        (t.bezierCurveTo(r + h[1], o + h[2], r + h[3], o + h[4], r + h[5], o + h[6]),
          (r += h[5]),
          (o += h[6]));
        break;
      case 'S':
      ...
      case 'z':
        ...
        break;
      default:
        wt(`Unknown SVG path command: ${l}`);
    }
    l !== 'Z' && l !== 'z' && i === null && ((i = { startX: r, startY: o }), n.push(i));
  }
  return t;
}
class Et {
  ...
  clone() {
    return new Et(this.x, this.y, this.radius);
  }
  contains(t, e) {
...
class Vt {
  ...
  clone() {
    return new Vt(this.x, this.y, this.halfWidth, this.halfHeight);
  }
  contains(t, e) {
...
function pn(s, t, e, n, i, r) {
  ...
  d !== 0 && (f = h / d);
  let u, x;
  f < 0 ? ((u = e), (x = n)) : f > 1 ? ((u = i), (x = r)) : ((u = e + f * c), (x = n + f * l));
  const y = s - u,
    p = t - x;
  return y * y + p * p;
}
...
class ut {
  ...
  getBounds(t) {
    ...
    for (let a = 0, c = e.length; a < c; a += 2) {
      const l = e[a],
        h = e[a + 1];
      ((n = l < n ? l : n), (i = l > i ? l : i), (r = h < r ? h : r), (o = h > o ? h : o));
    }
  ...
  get x() {
    return (
      L('8.11.0', 'Polygon.lastX is deprecated, please use Polygon.lastX instead.'),
      this.points[this.points.length - 2]
    );
  }
  get y() {
    return (
      L('8.11.0', 'Polygon.y is deprecated, please use Polygon.lastY instead.'),
...
class jt {
  ...
  clone() {
    return new jt(this.x, this.y, this.width, this.height, this.radius);
  }
  copyFrom(t) {
  ...
  strokeContains(t, e, n, i = 0.5) {
    const { x: r, y: o, width: a, height: c, radius: l } = this,
      h = n * (1 - i),
      d = n - h,
      f = r + l,
      u = o + l,
      ...
      p = r + a,
      _ = o + c;
    return (((t >= r - h && t <= r + d) || (t >= p - d && t <= p + h)) && e >= u && e <= u + y) ||
      (((e >= o - h && e <= o + d) || (e >= _ - d && e <= _ + h)) && t >= f && t <= f + x)
      ? !0
      : (t < f && e < u && St(t, e, f, u, l, d, h)) ||
          (t > p - l && e < u && St(t, e, p - l, u, l, d, h)) ||
          (t > p - l && e > _ - l && St(t, e, p - l, _ - l, l, d, h)) ||
          (t < f && e > _ - l && St(t, e, f, _ - l, l, d, h));
  }
  toString() {
    return `[pixi.js/math:RoundedRectangle x=${this.x} y=${this.y}width=${this.width} height=${this.height} radius=${this.radius}]`;
  }
}
function _n(s, t, e, n, i, r, o, a = null) {
  let c = 0;
  ((e *= t), (i *= r));
  const l = a.a,
    h = a.b,
  ...
  for (; c < o; ) {
    const y = s[e],
      p = s[e + 1];
    ((n[i] = l * y + d * p + u), (n[i + 1] = h * y + f * p + x), (i += r), (e += t), c++);
  }
}
function bn(s, t, e, n) {
  let i = 0;
...
function Me(s, t, e, n, i) {
  ...
  for (let f = 0; f < i; f++) {
    const u = s[d],
      x = s[d + 1];
    ((s[d] = r * u + a * x + l), (s[d + 1] = o * u + c * x + h), (d += n));
  }
}
const Pn = new B();
class Se {
  ...
  get color() {
    const t = this.baseColor,
      ...
      n = this.renderable;
    return n
      ? De(e, n.groupColor) + ((this.alpha * n.groupAlpha * 255) << 24)
      : e + ((this.alpha * 255) << 24);
  }
  get transform() {
    return this.renderable?.groupTransform || Pn;
  }
  copyTo(t) {
...
const pt = {
    extension: { type: j.ShapeBuilder, name: 'circle' },
    build(s, t) {
      let e, n, i, r, o, a;
      if (s.type === 'circle') {
        const m = s;
        ...
        ((e = m.x + w),
          (n = m.y + P),
          (o = a = Math.max(0, Math.min(m.radius, Math.min(w, P)))),
          (i = w - o),
          (r = P - a));
      }
      if (i < 0 || r < 0) return !1;
      const c = Math.ceil(2.3 * Math.sqrt(o + a)),
        l = c * 8 + (i ? 4 : 0) + (r ? 4 : 0);
      if (l === 0) return !1;
      if (c === 0)
        return (
      ...
      let h = 0,
        ...
        _ = e - x,
        g = n + y;
      if (((t[h++] = p), (t[h++] = g), (t[--d] = g), (t[--d] = _), r)) {
        const m = n - y;
        ((t[f++] = _), (t[f++] = m), (t[--u] = m), (t[--u] = p));
      }
      for (let m = 1; m < c; m++) {
        const w = (Math.PI / 2) * (m / c),
          P = i + Math.cos(w) * o,
          b = r + Math.sin(w) * a,
          R = e + P,
          v = e - P,
    ...
    triangulate(s, t, e, n, i, r) {
      ...
      let o = 0,
        a = 0;
      for (let h = 0; h < s.length; h += 2) ((o += s[h]), (a += s[h + 1]));
      ...
      for (let h = 0; h < s.length; h += 2)
        ((t[c * e] = s[h]),
          (t[c * e + 1] = s[h + 1]),
          h > 0 && ((i[r++] = c), (i[r++] = l), (i[r++] = c - 1)),
          c++);
      ((i[r++] = l + 1), (i[r++] = l), (i[r++] = c - 1));
    },
  },
  Mn = { ...pt, extension: { ...pt.extension, name: 'ellipse' } },
  Sn = { ...pt, extension: { ...pt.extension, name: 'roundedRectangle' } },
  ke = 1e-4,
  ne = 1e-4;
function kn(s) {
  const t = s.length;
...
function Cn(s, t, e, n, i, r) {
  ...
  const l = new J(s[0], s[1]),
    h = new J(s[s.length - 2], s[s.length - 1]),
    d = n,
    f = Math.abs(l.x - h.x) < o && Math.abs(l.y - h.y) < o;
  if (d) {
    ((s = s.slice()), f && (s.pop(), s.pop(), h.set(s[s.length - 2], s[s.length - 1])));
    const G = (l.x + h.x) * 0.5,
      V = (h.y + l.y) * 0.5;
    (s.unshift(G, V), s.push(G, V));
  }
  const u = i,
    x = s.length / 2;
  let y = s.length;
  ...
  (d ||
    (a.cap === 'round'
      ...
      : a.cap === 'square' && (y += se(m, w, S, C, k, T, !0, u))),
    u.push(m - S * k, w - C * k),
    u.push(m + S * T, w + C * T));
  for (let G = 1; G < x - 1; ++G) {
    ((m = s[(G - 1) * 2]),
    ...
    const V = P - m,
      ...
      mt = nt * st - it * V,
      rt = mt < 0;
    if (Math.abs(mt) < 0.001 * Math.abs($t)) {
      (u.push(P - S * k, b - C * k),
        u.push(P + S * T, b + C * T),
        $t >= 0 &&
          (a.join === 'round'
            ? (y += Y(P, b, P - S * k, b - C * k, P - F * k, b - I * k, u, !1) + 4)
            : (y += 2),
          u.push(P - F * T, b - I * T),
          u.push(P + F * k, b + I * k)));
      continue;
    }
    const Ut = (-S + m) * (-C + b) - (-S + P) * (-C + w),
      Zt = (-F + R) * (-I + b) - (-F + P) * (-I + v),
      _t = (V * Zt - st * Ut) / mt,
      bt = (it * Ut - nt * Zt) / mt,
      vt = (_t - P) * (_t - P) + (bt - b) * (bt - b),
      $ = P + (_t - P) * k,
      U = b + (bt - b) * k,
      Z = P - (_t - P) * T,
      X = b - (bt - b) * T,
      Fe = Math.min(V * V + nt * nt, st * st + it * it),
      Xt = rt ? k : T,
      Ie = Fe + Xt * Xt * g;
    vt <= Ie
      ? a.join === 'bevel' || vt / g > M
        ...
        : a.join === 'round'
          ? rt
            ? (u.push($, U),
              u.push(P + S * T, b + C * T),
              (y += Y(P, b, P + S * T, b + C * T, P + F * T, b + I * T, u, !0) + 4),
              u.push($, U),
              u.push(P + F * T, b + I * T))
            : (u.push(P - S * k, b - C * k),
              u.push(Z, X),
      ...
      : (u.push(P - S * k, b - C * k),
        ...
        a.join === 'round'
          ? rt
            ? (y += Y(P, b, P + S * T, b + C * T, P + F * T, b + I * T, u, !0) + 2)
            : (y += Y(P, b, P - S * k, b - C * k, P - F * k, b - I * k, u, !1) + 2)
          : a.join === 'miter' &&
            vt / g <= M &&
            (rt ? (u.push(Z, X), u.push(Z, X)) : (u.push($, U), u.push($, U)), (y += 2)),
        u.push(P - F * k, b - I * k),
        u.push(P + F * T, b + I * T),
        (y += 2));
  }
  ((m = s[(x - 2) * 2]),
    ...
    d ||
      (a.cap === 'round'
        ...
        : a.cap === 'square' && (y += se(P, b, S, C, k, T, !1, u))));
  const et = ne * ne;
  for (let G = p; G < y + p - 2; ++G)
    ((m = u[G * 2]),
      ...
      (R = u[(G + 2) * 2]),
      (v = u[(G + 2) * 2 + 1]),
      !(Math.abs(m * (b - v) + P * (v - w) + R * (w - b)) < et) && r.push(G, G + 1, G + 2));
}
function wn(s, t, e, n) {
  const i = ke;
  if (s.length === 0) return;
  const r = s[0],
    ...
    a = s[s.length - 2],
    c = s[s.length - 1],
    l = t || (Math.abs(r - a) < i && Math.abs(o - c) < i),
    h = e,
    d = s.length / 2,
    f = h.length / 2;
  for (let u = 0; u < d; u++) (h.push(s[u * 2]), h.push(s[u * 2 + 1]));
  for (let u = 0; u < d - 1; u++) n.push(f + u, f + u + 1);
  l && n.push(f + d - 1, f);
}
function Ce(s, t, e, n, i, r, o) {
  const a = on(s, t, 2);
  if (!a) return;
  for (let l = 0; l < a.length; l += 3)
    ((r[o++] = a[l] + i), (r[o++] = a[l + 1] + i), (r[o++] = a[l + 2] + i));
  let c = i * n;
  for (let l = 0; l < s.length; l += 2) ((e[c] = s[l]), (e[c + 1] = s[l + 1]), (c += n));
}
const Tn = [],
  vn = {
    extension: { type: j.ShapeBuilder, name: 'polygon' },
    build(s, t) {
  ...
  Rn = {
    extension: { type: j.ShapeBuilder, name: 'rectangle' },
    build(s, t) {
      const e = s,
        n = e.x,
        i = e.y,
  ...
  Gn = {
    extension: { type: j.ShapeBuilder, name: 'triangle' },
    build(s, t) {
      return (
        (t[0] = s.x),
        (t[1] = s.y),
...
function Hn(s, t, e, n) {
  ...
  return (
    ...
    n && i.append(Fn.copyFrom(n).invert()),
    i
  );
}
const Tt = {};
pe.handleByMap(j.ShapeBuilder, Tt);
pe.add(Rn, vn, Gn, pt, Mn, Sn);
const zn = new N(),
  Dn = new B();
function Ln(s, t) {
...
function An(s, t, e) {
  ...
  const { vertices: a, uvs: c, indices: l } = e,
    h = l.length,
    d = a.length / 2;
  (o && Me(n, o), i.triangulate(n, a, 2, d, l, h));
  const f = s.image,
    u = f.uvs;
  c.push(u.x0, u.y0, u.x1, u.y1, u.x3, u.y3, u.x2, u.y2);
  const x = lt.get(Se);
  ((x.indexOffset = h),
    (x.indexSize = l.length - h),
    (x.attributeOffset = d),
...
function ie(s, t, e, n, i) {
  ...
  s.shapePrimitives.forEach(({ shape: c, transform: l, holes: h }) => {
    const d = [],
      f = Tt[c.type];
    if (!f.build(c, d)) return;
    const u = a.length,
      x = r.length / 2;
    let y = 'triangle-list';
    if ((l && Me(d, l), e)) {
      const M = c.closePath ?? !0,
        m = t;
      m.pixelLine ? (wn(d, M, r, a), (y = 'line-list')) : Cn(d, m, !1, M, r, a);
    } else if (h) {
      const M = [],
        m = d.slice();
      (qn(h).forEach((P) => {
    ...
    if (_ !== Q.WHITE) {
      const M = Hn(Dn, t, c, l);
      _n(r, 2, x, o, p, 2, r.length / 2 - x, M);
    } else bn(o, p, 2, r.length / 2 - x);
    const g = lt.get(Se);
    ((g.indexOffset = u),
...
class En {
  ...
  init(t) {
    ((this.batcher = new je({ maxTextures: t })), this.instructions.reset());
  }
  get geometry() {
    return (
      L(
...
const Wt = class Dt {
  ...
  init(t) {
    Dt.defaultOptions.bezierSmoothness = t?.bezierSmoothness ?? Dt.defaultOptions.bezierSmoothness;
  }
  ...
  _initContextRenderData(t) {
    const e = lt.get(En, { maxTextures: this._renderer.limits.maxBatchableTextures }),
    ...
    const c = a.geometry;
    (c.indexBuffer.setDataWithSize(a.indexBuffer, a.indexSize, !0),
      c.buffers[0].setDataWithSize(a.attributeBuffer.float32View, a.attributeSize, !0));
    const l = a.batches;
...
Wt.extension = { type: [j.WebGLSystem, j.WebGPUSystem, j.CanvasSystem], name: 'graphicsContext' };
Wt.defaultOptions = { bezierSmoothness: 0.5 };
let we = Wt;
const Vn = 8,
  kt = 11920929e-14,
  jn = 1;
function Te(s, t, e, n, i, r, o, a, c, l) {
  const d = Math.min(0.99, Math.max(0, l ?? we.defaultOptions.bezierSmoothness));
  let f = (jn - d) / 1;
  return ((f *= f), Wn(t, e, n, i, r, o, a, c, s, f), s);
}
function Wn(s, t, e, n, i, r, o, a, c, l) {
  (Lt(s, t, e, n, i, r, o, a, c, l, 0), c.push(o, a));
}
function Lt(s, t, e, n, i, r, o, a, c, l, h) {
  if (h > Vn) return;
  const d = (s + e) / 2,
    f = (t + n) / 2,
    u = (e + i) / 2,
  ...
  if (h > 0) {
    ...
    } else if (((b = w - (s + o) / 2), (R = P - (t + a) / 2), b * b + R * R <= l)) {
      c.push(w, P);
      return;
    }
  }
  (Lt(s, t, d, f, _, g, w, P, c, l, h + 1), Lt(w, P, M, m, y, p, o, a, c, l, h + 1));
}
const Nn = 8,
  $n = 11920929e-14,
  Un = 1;
function Zn(s, t, e, n, i, r, o, a) {
  const l = Math.min(0.99, Math.max(0, a ?? we.defaultOptions.bezierSmoothness));
  let h = (Un - l) / 1;
  return ((h *= h), Xn(t, e, n, i, r, o, s, h), s);
}
function Xn(s, t, e, n, i, r, o, a) {
  (At(o, s, t, e, n, i, r, a, 0), o.push(i, r));
}
function At(s, t, e, n, i, r, o, a, c) {
  if (c > Nn) return;
  const l = (t + n) / 2,
    h = (e + i) / 2,
    d = (n + r) / 2,
  ...
  (At(s, t, e, l, h, u, x, a, c + 1), At(s, u, x, d, f, r, o, a, c + 1));
}
function ve(s, t, e, n, i, r, o, a) {
  let c = Math.abs(i - r);
  (((!o && i > r) || (o && r > i)) && (c = 2 * Math.PI - c),
    a || (a = Math.max(6, Math.floor(6 * Math.pow(n, 1 / 3) * (c / Math.PI)))),
    (a = Math.max(a, 3)));
  let l = c / a,
    h = i;
  l *= o ? -1 : 1;
...
function Yn(s, t, e, n, i, r) {
  ...
  const u = c * c + l * l,
    ...
    R = d * (p + M),
    v = h * (p + M),
    S = Math.atan2(b - w, P - m),
    C = Math.atan2(v - w, R - m);
  ve(s, m + t, w + e, r, S, C, l * h > d * c);
}
const dt = Math.PI * 2,
  Gt = { centerX: 0, centerY: 0, ang1: 0, ang2: 0 },
  Ft = ({ x: s, y: t }, e, n, i, r, o, a, c) => {
    ((s *= e), (t *= n));
    const l = i * s - r * t,
      h = r * s + i * t;
    return ((c.x = l + o), (c.y = h + a), c);
  };
function Qn(s, t) {
...
function On(s, t, e, n, i, r, o, a = 0, c = 0, l = 0) {
  if (r === 0 || o === 0) return;
  const h = Math.sin((a * dt) / 360),
    d = Math.cos((a * dt) / 360),
    f = (d * (t - n)) / 2 + (h * (e - i)) / 2,
    u = (-h * (t - n)) / 2 + (d * (e - i)) / 2;
  if (f === 0 && u === 0) return;
  ...
  (x > 1 && ((r *= Math.sqrt(x)), (o *= Math.sqrt(x))), Kn(t, e, n, i, r, o, c, l, h, d, f, u, Gt));
  let { ang1: y, ang2: p } = Gt;
  const { centerX: _, centerY: g } = Gt;
  let M = Math.abs(p) / (dt / 4);
  ...
  for (let R = 0; R < m; R++) {
    const v = Qn(y, p),
      { x: S, y: C } = Ft(v[0], r, o, d, h, _, g, b),
      { x: F, y: I } = Ft(v[1], r, o, d, h, _, g, b),
      { x: H, y: O } = Ft(v[2], r, o, d, h, _, g, b);
    (Te(s, w, P, S, C, F, I, H, O), (w = H), (P = O), (y += p));
  }
}
function Jn(s, t, e) {
  const n = (o, a) => {
  ...
  for (let o = 0; o < t.length; o++) {
    ...
    const y = f / 2;
    let p,
      _ = Math.abs((Math.cos(y) * c) / Math.sin(y));
    _ > Math.min(h.len / 2, d.len / 2)
      ? ((_ = Math.min(h.len / 2, d.len / 2)), (p = Math.abs((_ * Math.sin(y)) / Math.cos(y))))
      : (p = c);
    const g = a.x + d.nx * _ + -d.ny * p * u,
      M = a.y + d.ny * _ + d.nx * p * u,
      m = Math.atan2(h.ny, h.nx) + (Math.PI / 2) * u,
      w = Math.atan2(d.ny, d.nx) - (Math.PI / 2) * u;
...
function ts(s, t, e, n) {
  const i = (a, c) => Math.sqrt((a.x - c.x) ** 2 + (a.y - c.y) ** 2),
    r = (a, c, l) => ({ x: a.x + (c.x - a.x) * l, y: a.y + (c.y - a.y) * l }),
    o = t.length;
  for (let a = 0; a < o; a++) {
    const c = t[(a + 1) % o],
      l = c.radius ?? e;
    ...
    if (x < 1e-4) y = c;
      ...
      const p = Math.min(x / 2, l);
      y = r(c, d, p / x);
    }
    (a === 0 ? s.moveTo(u.x, u.y) : s.lineTo(u.x, u.y), s.quadraticCurveTo(c.x, c.y, y.x, y.y, n));
  }
}
const es = new N();
class ns {
  ...
  arc(t, e, n, i, r, o) {
    ...
    return (ve(a, t, e, n, i, r, o), this);
  }
  arcTo(t, e, n, i, r) {
    this._ensurePoly();
    const o = this._currentPoly.points;
    return (Yn(o, t, e, n, i, r), this);
  }
  arcToSvg(t, e, n, i, r, o, a) {
    const c = this._currentPoly.points;
    return (On(c, this._currentPoly.lastX, this._currentPoly.lastY, o, a, t, e, n, i, r), this);
  }
  bezierCurveTo(t, e, n, i, r, o, a) {
    this._ensurePoly();
    const c = this._currentPoly;
    return (Te(this._currentPoly.points, c.lastX, c.lastY, t, e, n, i, r, o, a), this);
  }
  quadraticCurveTo(t, e, n, i, r) {
    this._ensurePoly();
    const o = this._currentPoly;
    return (Zn(this._currentPoly.points, o.lastX, o.lastY, t, e, n, i, r), this);
  }
  closePath() {
  ...
  rect(t, e, n, i, r) {
    return (this.drawShape(new N(t, e, n, i), r), this);
  }
  circle(t, e, n, i) {
    return (this.drawShape(new Et(t, e, n), i), this);
  }
  poly(t, e, n) {
    const i = new ut(t);
  ...
  roundPoly(t, e, n, i, r, o = 0, a) {
    ...
    for (let f = 0; f < i; f++) {
      const u = f * h + l,
        ...
        m = x + r * Math.cos(_),
        w = y + r * Math.sin(_);
      (f === 0 ? this.moveTo(g, M) : this.lineTo(g, M), this.quadraticCurveTo(x, y, m, w, a));
    }
    return this.closePath();
  }
  roundShape(t, e, n = !1, i) {
    return t.length < 3 ? this : (n ? ts(this, t, e, i) : Jn(this, t, e), this.closePath());
  }
  filletRect(t, e, n, i, r) {
    ...
    return this.moveTo(t, e + d)
      .arcTo(t + h, e + h, t + d, e, d)
      .lineTo(c - d, e)
      .arcTo(c - h, e + h, c, e + d, d)
      .lineTo(c, l - d)
      .arcTo(c - h, l - h, t + n - d, l, d)
      .lineTo(t + d, l)
      .arcTo(t + h, l - h, t, l - d, d)
      .closePath();
  }
  chamferRect(t, e, n, i, r, o) {
    ...
    const a = Math.min(r, Math.min(n, i) / 2),
      c = t + n,
      l = e + i,
      h = [t + a, e, c - a, e, c, e + a, c, l - a, c - a, l, t + a, l, t, l - a, t, e + a];
    for (let d = h.length - 1; d >= 2; d -= 2)
      h[d] === h[d - 2] && h[d - 1] === h[d - 3] && h.splice(d - 1, 2);
    return this.poly(h, !0, o);
  }
  ellipse(t, e, n, i, r) {
    return (this.drawShape(new Vt(t, e, n, i), r), this);
  }
  roundRect(t, e, n, i, r, o) {
    return (this.drawShape(new jt(t, e, n, i, r), o), this);
  }
  drawShape(t, e) {
  ...
  _ensurePoly(t = !0) {
    if (!this._currentPoly && ((this._currentPoly = new ut()), t)) {
...
class E {
  constructor(t, e = !1) {
    ((this.instructions = []),
      (this.uid = Ct('graphicsPath')),
      (this._dirty = !0),
      (this.checkForHoles = e),
      typeof t == 'string' ? yn(t, this) : (this.instructions = t?.slice() ?? []));
  }
  get shapePath() {
    return (
      this._shapePath || (this._shapePath = new ns(this)),
  ...
  bezierCurveToShort(t, e, n, i, r) {
    ...
    return (
      this.instructions.push({ action: 'bezierCurveTo', data: [c, l, t, e, n, i, r] }),
      (this._dirty = !0),
      this
    );
  }
  ...
  transform(t) {
    ...
    for (let p = 0; p < this.instructions.length; p++) {
      ...
      switch (_.action) {
        case 'moveTo':
        case 'lineTo':
          ((c = g[0]), (l = g[1]), (g[0] = e * c + i * l + o), (g[1] = n * c + r * l + a));
          break;
        case 'bezierCurveTo':
          ((h = g[0]),
            (d = g[1]),
        ...
        case 'poly':
          ...
          break;
        default:
          wt('unknown transform action', _.action);
          break;
      }
    }
...
function is(s) {
  ...
  for (let a = 0; a < s.children.length; a++) {
    const c = s.children[a],
      l = D(c, 'offset', 0),
      h = W.shared.setValue(c.getAttribute('stop-color')).toNumber();
    o.addColorStop(l, h);
  }
  return o;
}
function rs(s) {
  return (wt('[SVG Parser] Radial gradients are not yet supported'), new gt(0, 0, 1, 0));
}
function oe(s) {
  ...
  switch (e) {
    case 'stroke':
      if (n !== 'none') {
        ...
        } else t.strokeStyle.color = W.shared.setValue(n).toNumber();
        t.useStroke = !0;
      }
      break;
    case 'stroke-width':
    ...
    case 'fill':
      if (n !== 'none') {
        ...
        } else t.fillStyle.color = W.shared.setValue(n).toNumber();
        t.useFill = !0;
      }
      break;
    case 'fill-opacity':
...
function os(s) {
  ...
  const t = s.map((a) => a.area).sort((a, c) => c - a),
    [e, n] = t,
    i = t[t.length - 1],
    r = e / n,
    o = n / i;
...
function hs(s) {
  ...
  const e = t.map(Number),
    n = [],
    i = [];
  for (let h = 0; h < e.length; h += 2) h + 1 < e.length && (n.push(e[h]), i.push(e[h + 1]));
...
function ce(s, t) {
  const e = new E(s, !1);
  for (const n of e.instructions) t.instructions.push(n);
}
function cs(s, t) {
  if (typeof s == 'string') {
  ...
  const e = { context: t, defs: {}, path: new E() };
  ss(s, e);
  const n = s.children,
    { fillStyle: i, strokeStyle: r } = Re(s, e);
  for (let o = 0; o < n.length; o++) {
    const a = n[o];
    a.nodeName.toLowerCase() !== 'defs' && Ge(a, e, i, r);
  }
  return t;
}
function Ge(s, t, e, n) {
  const i = s.children,
    { fillStyle: r, strokeStyle: o } = Re(s, t);
  (r && e ? (e = { ...e, ...r }) : r && (e = r), o && n ? (n = { ...n, ...o }) : o && (n = o));
  const a = !e && !n;
  a && (e = { color: 0 });
  let c, l, h, d, f, u, x, y, p, _, g, M, m, w, P, b, R;
  switch (s.nodeName.toLowerCase()) {
    case 'path': {
      w = s.getAttribute('d');
      const v = s.getAttribute('fill-rule'),
        S = as(w),
        C = v === 'evenodd',
        F = S.length > 1;
      if (C && F) {
        const H = S.map((k) => ({ path: k, area: hs(k) }));
        if ((H.sort((k, T) => T.area - k.area), S.length > 3 || !os(H)))
          for (let k = 0; k < H.length; k++) {
            const T = H[k],
              et = k === 0;
            t.context.beginPath();
            const G = new E(void 0, !0);
            (ce(T.path, G),
              t.context.path(G),
              et ? (e && t.context.fill(e), n && t.context.stroke(n)) : t.context.cut());
          }
        else
          for (let k = 0; k < H.length; k++) {
            const T = H[k],
            ...
            (ce(T.path, G),
              t.context.path(G),
              et ? t.context.cut() : (e && t.context.fill(e), n && t.context.stroke(n)));
          }
      } else {
        const H = v ? v === 'evenodd' : !0;
        ((P = new E(w, H)), t.context.path(P), e && t.context.fill(e), n && t.context.stroke(n));
      }
      break;
    }
    case 'circle':
    ...
    case 'rect':
      ((c = D(s, 'x', 0)),
        ...
        (_ = D(s, 'rx', 0)),
        (g = D(s, 'ry', 0)),
        _ || g ? t.context.roundRect(c, l, b, R, _ || g) : t.context.rect(c, l, b, R),
        e && t.context.fill(e),
        n && t.context.stroke(n));
      break;
    case 'ellipse':
    ...
    case 'svg':
      break;
    default: {
      wt(`[SVG parser] <${s.nodeName}> elements unsupported`);
      break;
    }
  }
  a && (e = null);
  for (let v = 0; v < i.length; v++) Ge(i[v], t, e, n);
}
function ls(s) {
  return W.isColorLike(s);
}
function le(s) {
...
function xe(s, t) {
  const { width: e, alignment: n, miterLimit: i, cap: r, join: o, pixelLine: a, ...c } = t,
    l = ct(s, c);
  return l ? { width: e, alignment: n, miterLimit: i, cap: r, join: o, pixelLine: a, ...l } : null;
}
const ys = new J(),
  ye = new B(),
  Nt = class q extends qe {
    constructor() {
      (super(...arguments),
        (this.uid = Ct('graphicsContext')),
        (this.dirty = !0),
        (this.batchMode = 'auto'),
        (this.instructions = []),
        (this._activePath = new E()),
    ...
    set fillStyle(t) {
      this._fillStyle = ct(t, q.defaultFillStyle);
    }
    get strokeStyle() {
      return this._strokeStyle;
    }
    set strokeStyle(t) {
      this._strokeStyle = xe(t, q.defaultStrokeStyle);
    }
    setFillStyle(t) {
      return ((this._fillStyle = ct(t, q.defaultFillStyle)), this);
    }
    setStrokeStyle(t) {
      return ((this._strokeStyle = ct(t, q.defaultStrokeStyle)), this);
    }
    texture(t, e, n, i, r, o) {
      return (
    ...
    beginPath() {
      return ((this._activePath = new E()), this);
    }
    fill(t, e) {
      let n;
      const i = this.instructions[this.instructions.length - 1];
    ...
    stroke(t) {
      ...
      return (
        ...
        e
          ? (t != null && (this._strokeStyle = xe(t, q.defaultStrokeStyle)),
            this.instructions.push({
              action: 'stroke',
    ...
    svg(t) {
      return (this._tick++, cs(t, this), this);
    }
    restore() {
    ...
    transform(t, e, n, i, r, o) {
      return t instanceof B
        ...
        : (ye.set(t, e, n, i, r, o), this._transform.append(ye), this);
    }
    translate(t, e = t) {
    ...
    containsPoint(t) {
      ...
      for (let i = 0; i < e.length; i++) {
        ...
        for (let h = 0; h < l.length; h++) {
          const d = l[h].shape;
          if (!c || !d) continue;
          const f = l[h].transform,
            u = f ? f.applyInverse(t, ys) : t;
...
class qt extends Be {
  constructor(t) {
    t instanceof at && (t = { context: t });
    const { context: e, roundPixels: n, ...i } = t || {};
    (super({ label: 'Graphics', ...i }),
      (this.renderPipeId = 'graphics'),
      e ? (this._context = e) : (this._context = this._ownedContext = new at()),
  ...
  clone(t = !1) {
    return t ? new qt(this._context.clone()) : ((this._ownedContext = null), new qt(this._context));
  }
  lineStyle(t, e, n) {
    L(
      A,
  ...
  endFill() {
    ...
    return (
      (t.width !== at.defaultStrokeStyle.width ||
        t.color !== at.defaultStrokeStyle.color ||
        t.alpha !== at.defaultStrokeStyle.alpha) &&
        this.context.stroke(),
      this
    );
  }
  drawCircle(...t) {
    return (
      L(A, 'Graphics#drawCircle has been renamed to Graphics#circle'),
      this._callContextMethod('circle', t)
    );
  }
  drawEllipse(...t) {
    return (
      L(A, 'Graphics#drawEllipse has been renamed to Graphics#ellipse'),
      this._callContextMethod('ellipse', t)
    );
  }
  drawPolygon(...t) {
    return (
      L(A, 'Graphics#drawPolygon has been renamed to Graphics#poly'),
      this._callContextMethod('poly', t)
    );
  }
  drawRect(...t) {
    return (
      L(A, 'Graphics#drawRect has been renamed to Graphics#rect'),
      this._callContextMethod('rect', t)
    );
  }
  drawRoundedRect(...t) {
    return (
      L(A, 'Graphics#drawRoundedRect has been renamed to Graphics#roundRect'),
      this._callContextMethod('roundRect', t)
    );
  }
  drawStar(...t) {
    return (
      L(A, 'Graphics#drawStar has been renamed to Graphics#star'),
      this._callContextMethod('star', t)
    );
  }
}
export { Se as B, gt as F, qt as G, at as a, xe as b, hn as c, we as d, ct as t };
