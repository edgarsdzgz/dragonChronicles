    ...
    ((this._lastTransform = ''),
      ...
      (this.updateTranslation = () => {
        ...
        const t = this._canvas.getBoundingClientRect(),
          ...
          s = (t.width / i) * this._renderer.resolution,
          o = (t.height / n) * this._renderer.resolution,
          r = t.left,
          h = t.top,
          d = `translate(${r}px, ${h}px) scale(${s}, ${o})`;
        ...
        (this._observer = new ResizeObserver((e) => {
          for (const t of e) {
            ...
            const i = this.canvas.width,
              ...
              s = (t.contentRect.width / i) * this._renderer.resolution,
              o = (t.contentRect.height / n) * this._renderer.resolution;
            (this._lastScaleX !== s || this._lastScaleY !== o) &&
              (this.updateTranslation(), (this._lastScaleX = s), (this._lastScaleY = o));
          }
        })),
        this._observer.observe(this._canvas))
      : this._tickerAttached || O.shared.add(this.updateTranslation, this, Z.HIGH);
  }
  destroy() {
    (this._observer
      ? (this._observer.disconnect(), (this._observer = null))
      : this._tickerAttached && O.shared.remove(this.updateTranslation),
...
class w {
  constructor(e) {
    ((this.bubbles = !0),
      ...
      (this.eventPhase = w.prototype.NONE),
...
var I = /iPhone/i,
  ...
  K = function (a) {
    return (
      typeof a < 'u' &&
      a.platform === 'MacIntel' &&
      typeof a.maxTouchPoints == 'number' &&
      a.maxTouchPoints > 1 &&
      typeof MSStream > 'u'
    );
  };
...
function G(a) {
  ...
  var n = ne(t),
    s = {
      ...
      amazon: { phone: n(b), tablet: !n(b) && n(M), device: n(b) || n(M) },
      android: {
        phone: (!n(v) && n(b)) || (!n(v) && n(k)),
        tablet: !n(v) && !n(b) && !n(k) && (n(M) || n(R)),
        device: (!n(v) && (n(b) || n(M) || n(k) || n(R))) || n(/\bokhttp\b/i),
      },
      windows: { phone: n(v), tablet: n(X), device: n(v) || n(X) },
      other: {
        blackberry: n(Y),
        blackberry10: n(H),
        opera: n(F),
...
const se = G.default ?? G,
  oe = se(globalThis.navigator),
  re = 9,
  W = 100,
  ae = 0,
  he = 0,
  ...
  S = class J {
    ...
    _activate() {
      ...
      ((this._isActive = !0),
        this._div ||
          ...
          (this._div.style.top = `${ae}px`),
          (this._div.style.left = `${he}px`),
          (this._div.style.pointerEvents = 'none'),
          (this._div.style.zIndex = j.toString()),
          (this._canvasObserver = new q({ domElement: this._div, renderer: this._renderer }))),
        this._activateOnTab &&
      ...
      if (e.parentNode) (this._canvasObserver.ensureAttached(), this._initAccessibilitySetup());
        ...
        const t = new MutationObserver(() => {
          e.parentNode &&
            (t.disconnect(), this._canvasObserver.ensureAttached(), this._initAccessibilitySetup());
        });
    ...
    init(e) {
      const i = {
        accessibilityOptions: { ...J.defaultOptions, ...(e?.accessibilityOptions || {}) },
      };
    ...
    postrender() {
      ...
      for (let i = 0; i < this._children.length; i++) {
        ...
        const s = n._accessibleDiv,
          o = n.hitArea || n.getBounds().rectangle;
        if (n.hitArea) {
          const r = n.worldTransform;
          ((s.style.left = `${r.tx + o.x * r.a}px`),
            (s.style.top = `${r.ty + o.y * r.d}px`),
            (s.style.width = `${o.width * r.a}px`),
            (s.style.height = `${o.height * r.d}px`));
        } else
          (this._capHitArea(o),
            (s.style.left = `${o.x}px`),
            (s.style.top = `${o.y}px`),
    ...
    _dispatchEvent(e, t) {
      const { container: i } = e.target,
        n = this._renderer.events.rootBoundary,
        s = Object.assign(new w(n), { target: i });
...
S.extension = { type: [y.WebGLSystem, y.WebGPUSystem], name: 'accessibility' };
S.defaultOptions = {
  enabledByDefault: !1,
  debug: !1,
  activateOnTab: !0,
...
class Q {
  ...
  postrender() {
    ...
    for (let t = 0; t < e.length; t++) {
      const i = e[t],
        n = i.element;
      if (!i.parent || i.globalDisplayStatus < 7) (n?.remove(), e.splice(t, 1), t--);
      else {
        this._domElement.contains(n) ||
          ((n.style.position = 'absolute'),
          (n.style.pointerEvents = 'auto'),
          this._domElement.appendChild(n));
        const s = i.worldTransform,
          o = i._anchor,
          r = i.width * o.x,
          h = i.height * o.y;
        ((n.style.transformOrigin = `${r}px ${h}px`),
          (n.style.transform = `matrix(${s.a}, ${s.b}, ${s.c}, ${s.d}, ${s.tx - r}, ${s.ty - h})`),
          (n.style.opacity = i.groupAlpha.toString()));
      }
    }
  }
  destroy() {
...
Q.extension = { type: [y.WebGLPipes, y.WebGPUPipes, y.CanvasPipes], name: 'dom' };
class ve {
  constructor() {
  ...
  addTickerListener() {
    this._tickerAdded ||
      !this.domElement ||
      (O.system.add(this._tickerUpdate, this, Z.INTERACTION), (this._tickerAdded = !0));
  }
...
class _e {
  ...
  mapEvent(e) {
    ...
    else _(`[EventBoundary]: Event mapping not defined for ${e.type}`);
  }
  hitTest(e, t) {
    g.pauseUpdate = !0;
    const n =
  ...
  hitTestMoveRecursive(e, t, i, n, s, o = !1) {
    ...
    if (
      ((e.eventMode === 'dynamic' || t === 'dynamic') && (g.pauseUpdate = !1),
      ...
      for (let m = l.length - 1; m >= 0; m--) {
        ...
        if (p) {
          ...
          ((p.length > 0 || D) && (D && this._allInteractiveElements.push(e), p.push(e)),
  ...
  hitTestRecursive(e, t, i, n, s) {
    ...
    if (
      ...
      for (let l = h.length - 1; l >= 0; l--) {
        const m = h[l],
          c = this.hitTestRecursive(m, this._isInteractive(t) ? t : m.eventMode, d, n, s);
        if (c) {
  ...
  hitTestFn(e, t) {
    return e.hitArea
      ? !0
      : e?.containsPoint
        ? (e.worldTransform.applyInverse(t, T), e.containsPoint(T))
        : !1;
  }
  notifyTarget(e, t) {
  ...
  mapPointerMove(e) {
    ...
    if (n.overTargets?.length > 0 && s !== t.target) {
      const h = e.type === 'mousemove' ? 'mouseout' : 'pointerout',
        d = this.createPointerEvent(e, h, s);
      if (
    ...
    if (s !== t.target) {
      ...
      if (!l || l === this.rootTarget.parent) {
        ...
        for (
          ...
          c.target && c.target !== s && c.target !== this.rootTarget.parent;
    ...
    if (o) {
      ...
      ((r.target = o),
        ...
        n.clicksByButton[e.button] ||
          (n.clicksByButton[e.button] = { clickCount: 0, target: r.target, timeStamp: t }));
      const h = n.clicksByButton[e.button];
      if (
        (h.target === r.target && t - h.timeStamp < 200 ? ++h.clickCount : (h.clickCount = 1),
        (h.target = r.target),
        (h.timeStamp = t),
        (r.detail = h.clickCount),
        r.pointerType === 'mouse')
      ) {
        const d = r.button === 2;
  ...
  mapWheel(e) {
    if (!(e instanceof E)) {
      _('EventBoundary cannot map a non-wheel event as a wheel event');
      return;
    }
  ...
  B = class x {
    constructor(e) {
      ((this.supportsTouchEvents = 'ontouchstart' in globalThis),
        ...
        (this.resolution = 1),
        (this.renderer = e),
        (this.rootBoundary = new _e(null)),
        g.init(this),
        (this.autoPreventDefault = !0),
        (this._eventsAdded = !1),
        (this._rootPointerEvent = new u(null)),
        (this._rootWheelEvent = new E(null)),
    ...
    init(e) {
      ...
      (this.setTargetElement(t),
        (this.resolution = i),
        (x._defaultEventMode = e.eventMode ?? 'passive'),
    ...
    _onPointerMove(e) {
      ...
      ((this.rootBoundary.rootTarget = this.renderer.lastObjectRendered), g.pointerMoved());
      const t = this._normalizeToPointerData(e);
      for (let i = 0, n = t.length; i < n; i++) {
    ...
    setTargetElement(e) {
      (this._removeEvents(), (this.domElement = e), (g.domElement = e), this._addEvents());
    }
    _addEvents() {
    ...
    _normalizeToPointerData(e) {
      ...
      if (this.supportsTouchEvents && e instanceof TouchEvent)
        ...
        (typeof i.isPrimary > 'u' && (i.isPrimary = !0),
          ...
          typeof i.pointerId > 'u' && (i.pointerId = ge),
    ...
    _bootstrapEvent(e, t) {
      return (
        ...
        e.type.startsWith('touch') && (e.type = ye[e.type] || e.type),
        e
      );
    }
...
B.extension = {
  name: 'events',
  type: [y.WebGLSystem, y.CanvasSystem, y.WebGPUSystem],
  priority: -1,
};
B.defaultEventFeatures = { move: !0, globalMove: !0, click: !0, wheel: !0 };
let ee = B;
const be = {
  onclick: null,
  onmousedown: null,
  ...
  addEventListener(a, e, t) {
    const i = (typeof t == 'boolean' && t) || (typeof t == 'object' && t.capture),
      n = typeof t == 'object' ? t.signal : void 0,
      s = typeof t == 'object' ? t.once === !0 : !1,
      o = typeof e == 'function' ? void 0 : e;
    a = i ? `${a}capture` : a;
    const r = typeof e == 'function' ? e : e.handleEvent,
      h = this;
    (n &&
