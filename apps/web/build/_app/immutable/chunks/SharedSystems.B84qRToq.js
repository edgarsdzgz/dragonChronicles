...
import { S as fe, B as pe, c as Ze } from './colorToUniform.DmtBy-2V.js';
const me = class G extends Xe {
  constructor(e) {
    ((e = { ...G.defaultOptions, ...e }),
      super(e),
      (this.enabled = !0),
  ...
  static from(e) {
    ...
    return (
      t && (n = ue.from(t)),
      r && (i = de.from(r)),
      new G({ gpuProgram: n, glProgram: i, ...s })
    );
  }
};
me.defaultOptions = {
...
class st extends et {
  constructor(e) {
    const { sprite: t, ...r } = e,
      ...
      i = ue.from({
        vertex: { source: ee, entryPoint: 'mainVertex' },
        fragment: { source: ee, entryPoint: 'mainFragment' },
      }),
      o = de.from({ vertex: rt, fragment: tt, name: 'mask-filter' });
    (super({
      ...r,
      gpuProgram: i,
      glProgram: o,
...
const W = class ve {
  ...
  buildStart(e) {
    ...
    (t ||
      ...
      t.default ||
        (t.default = new he({ maxTextures: this.renderer.limits.maxBatchableTextures }))),
  ...
  addToBatch(e, t) {
    if (this._activeBatch.name !== e.batcherName) {
      ...
      (r || ((r = this._activeBatches[e.batcherName] = ve.getBatcher(e.batcherName)), r.begin()),
        (this._activeBatch = r));
    }
...
W.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'batch' };
W._availableBatchers = Object.create(null);
let ge = W;
  ...
  execute(e) {
    ...
    if (e.action === 'pushMaskBegin') {
      ...
      if (((s.inverse = e.inverse), r)) {
        ...
        const n = He(e.mask.mask, !0, at);
        ((e.mask.mask.measurable = !1), n.ceil());
        const i = t.renderTarget.renderTarget.colorTexture.source,
          o = b.getOptimalTexture(n.width, n.height, i._resolution, i.antialias);
        (t.renderTarget.push(o, !0), t.globalUniforms.push({ offset: n, worldColor: 4294967295 }));
        const l = s.sprite;
        ((l.texture = o),
        ...
        ((s.sprite = e.mask.mask),
          this._activeMaskStage.push({ filterEffect: s, maskedContainer: e.maskedContainer }));
    } else if (e.action === 'pushMaskEnd') {
      const s = this._activeMaskStage[this._activeMaskStage.length - 1];
      (r &&
        (t.type === z.WEBGL && t.renderTarget.finishRenderPass(),
        t.renderTarget.pop(),
...
xe.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'alphaMask' };
class _e {
  constructor(e) {
    ((this._colorStack = []),
  ...
  push(e, t, r) {
    ...
    (i !== this._currentColor &&
      ((this._currentColor = i), r.add({ renderPipeId: 'colorMask', colorMask: i, canBundle: !1 })),
...
_e.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'colorMask' };
class be {
  constructor(e) {
  ...
  execute(e) {
    ...
    (e.action === 'pushMaskBegin'
      ? (r.renderTarget.ensureDepthStencil(),
        r.stencil.setStencilMode(f.RENDERING_MASK_ADD, n),
        n++,
        r.colorMask.setMask(0))
      : e.action === 'pushMaskEnd'
        ? (e.inverse
            ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, n)
            : r.stencil.setStencilMode(f.MASK_ACTIVE, n),
          r.colorMask.setMask(15))
        : e.action === 'popMaskBegin'
          ? (r.colorMask.setMask(0),
            n !== 0
              ? r.stencil.setStencilMode(f.RENDERING_MASK_REMOVE, n)
              : (r.renderTarget.clear(null, B.STENCIL), r.stencil.setStencilMode(f.DISABLED, n)),
            n--)
          : e.action === 'popMaskEnd' &&
            (e.inverse
              ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, n)
              : r.stencil.setStencilMode(f.MASK_ACTIVE, n),
            r.colorMask.setMask(15)),
      (this._maskStackHash[s] = n));
  }
  destroy() {
    ((this._renderer = null), (this._maskStackHash = null), (this._maskHash = null));
  }
}
be.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'stencilMask' };
function It(a, e) {
  for (const t in a.attributes) {
    const r = a.attributes[t],
      s = e[t];
    s
      ? (r.format ?? (r.format = s.format),
        r.offset ?? (r.offset = s.offset),
        r.instance ?? (r.instance = s.instance))
      : L(
...
function it(a) {
  const { buffers: e, attributes: t } = a,
    r = {},
    s = {};
  for (const n in e) {
    const i = e[n];
  ...
  for (const n in t) {
    ...
    (i.stride ?? (i.stride = r[i.buffer.uid]),
      i.start ?? (i.start = s[i.buffer.uid]),
      (s[i.buffer.uid] += Q(i.format).stride));
  }
}
const x = [];
x[f.NONE] = void 0;
x[f.DISABLED] = { stencilWriteMask: 0, stencilReadMask: 0 };
...
class Dt {
  ...
  syncUniformGroup(e, t, r) {
    ...
    let n = null;
    return (
      t || ((t = e.buffer.data), (n = e.buffer.dataInt32)),
      r || (r = 0),
...
function Et(a, e, t, r) {
  ...
  for (let o = 0; o < a.length; o++) {
    ...
    for (let p = 0; p < C.length; p++)
      if (C[p].test(l.data)) {
        ((h = l.offset / 4),
          s.push(`name = "${d}";`, `offset += ${h - n};`, C[p][e] || C[p].ubo),
          (c = !0));
        break;
      }
    if (!c)
      if (l.data.size > 1) ((h = l.offset / 4), s.push(t(l, h - n)));
      else {
  ...
  const i = s.join(`
`);
  return new Function('uv', 'data', 'dataInt32', 'offset', i);
}
function g(a, e) {
  return `
        for (let i = 0; i < ${a * e}; i++) {
...
function Te(a, e) {
  if (!_.has(a)) {
    const t = new m({ source: new U({ resource: a, ...e }) }),
      r = () => {
...
const ye = class ke {
  constructor(e = {}) {
    ...
    (this.colorTexture.source.on('resize', this.onSourceResize, this),
      (e.depthStencilTexture || this.stencil) &&
        (e.depthStencilTexture instanceof m || e.depthStencilTexture instanceof T
  ...
  ensureDepthStencilTexture() {
    this.depthStencilTexture ||
      (this.depthStencilTexture = new T({
        width: this.width,
        height: this.height,
...
class Ft {
  constructor(e) {
    ((this.rootViewPort = new w()),
      (this.viewport = new w()),
      (this.onRenderTargetChange = new Ve('onRenderTargetChange')),
  ...
  renderStart({ target: e, clear: t, clearColor: r, frame: s }) {
    ((this._renderTargetStack.length = 0),
      ...
      (this.renderingToScreen = ut(this.rootRenderTarget)),
  ...
  bind(e, t = !0, r, s) {
    ...
    (n.pixelWidth !== o.width || n.pixelHeight !== o.height) &&
      (this.adaptor.resizeGpuRenderTarget(n), (o.width = n.pixelWidth), (o.height = n.pixelHeight));
    const l = n.colorTexture,
      d = this.viewport,
      c = l.pixelWidth,
      h = l.pixelHeight;
    if ((!s && e instanceof m && (s = e.frame), s)) {
      ...
      ((d.x = (s.x * p + 0.5) | 0),
        (d.y = (s.y * p + 0.5) | 0),
        (d.width = (s.width * p + 0.5) | 0),
        (d.height = (s.height * p + 0.5) | 0));
    } else ((d.x = 0), (d.y = 0), (d.width = c), (d.height = h));
    return (
      lt(this.projectionMatrix, 0, 0, d.width / l.resolution, d.height / l.resolution, !n.isRoot),
  ...
  push(e, t = B.ALL, r, s) {
    ...
    return (this._renderTargetStack.push({ renderTarget: n, frame: s }), n);
  }
  pop() {
  ...
  copyToTexture(e, t, r, s, n) {
    (r.x < 0 && ((s.width += r.x), (n.x -= r.x), (r.x = 0)),
      r.y < 0 && ((s.height += r.y), (n.y -= r.y), (r.y = 0)));
    const { pixelWidth: i, pixelHeight: o } = e;
    return (
      (s.width = Math.min(s.width, i - r.x)),
  ...
  _initRenderTarget(e) {
    let t = null;
    return (
      U.test(e) && (e = Te(e).source),
      e instanceof I
        ? (t = e)
        : e instanceof T &&
          ((t = new I({ colorTextures: [e] })),
          e.source instanceof U && (t.isRoot = !0),
          e.once('destroy', () => {
            (t.destroy(), this._renderSurfaceToRenderTargetHash.delete(e));
            const r = this._gpuRenderTargetHash[t.uid];
            r &&
              ((this._gpuRenderTargetHash[t.uid] = null), this.adaptor.destroyGpuRenderTarget(r));
          })),
...
Ce.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'customRender' };
function D(a, e) {
  const t = a.instructionSet,
    r = t.instructions;
...
class Me {
  ...
  _addRenderableDirect(e, t) {
    (this._renderer.renderPipes.batch.break(t),
      e._batchableRenderGroup &&
        (S.return(e._batchableRenderGroup), (e._batchableRenderGroup = null)),
      t.add(e));
  }
  ...
  _executeCacheAsTexture(e) {
    if (e.textureNeedsUpdate) {
      ...
      const t = dt.identity().translate(-e._textureBounds.x, -e._textureBounds.y);
      (this._renderer.renderTarget.push(e.texture, !0, null, e.texture.frame),
        this._renderer.globalUniforms.push({ worldTransformMatrix: t, worldColor: 4294967295 }),
        D(e, this._renderer.renderPipes),
...
Me.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'renderGroup' };
function E(a, e) {
  e || (e = 0);
...
function Se(a, e = !1) {
  ...
  if (e) for (let s = 0; s < a.renderGroupChildren.length; s++) Se(a.renderGroupChildren[s], e);
}
function ht(a) {
  const e = a.root;
  let t;
  if (a.renderGroupParent) {
    ...
    (a.worldTransform.appendFrom(e.relativeGroupTransform, r.worldTransform),
      (a.worldColor = ne(e.groupColor, r.worldColor)),
...
function we(a, e, t) {
  ...
  if (
    (s && !s.renderGroup
      ? ((t |= a._updateFlags),
        a.relativeGroupTransform.appendFrom(r, s.relativeGroupTransform),
        t & te && re(a, s, t))
      : ((t = a._updateFlags), a.relativeGroupTransform.copyFrom(r), t & te && re(a, ct, t)),
    !a.renderGroup)
  ) {
    const n = a.children,
      i = n.length;
    for (let d = 0; d < i; d++) we(n[d], e, t);
    const o = a.parentRenderGroup,
      l = a;
...
function re(a, e, t) {
  if (t & oe) {
    a.groupColor = ne(a.localColor, e.groupColor);
    let r = a.localAlpha * e.groupAlpha;
    ((r = r < 0 ? 0 : r > 1 ? 1 : r),
      (a.groupAlpha = r),
      (a.groupColorAlpha = a.groupColor + (((r * 255) | 0) << 24)));
  }
  (t & le &&
    (a.groupBlendMode = a.localBlendMode === 'inherit' ? e.groupBlendMode : a.localBlendMode),
    t & ie && (a.globalDisplayStatus = a.localDisplayStatus & e.globalDisplayStatus),
    (a._updateFlags = 0));
}
function ft(a, e) {
  ...
  for (let n = 0; n < r; n++) {
    const i = t[n];
    if (((s = e[i.renderPipeId].validateRenderable(i)), s)) break;
  }
...
class Pe {
  ...
  render({ container: e, transform: t }) {
    ...
    (this._updateCachedRenderGroups(e.renderGroup, null),
      ...
      t && e.renderGroup.localTransform.copyFrom(i),
      (e.parent = r),
  ...
  _updateCachedRenderGroups(e, t) {
    ...
    if ((e.invalidateMatrices(), e.isCachedAsTexture)) {
      if (e.textureNeedsUpdate) {
        ...
        const n = this._renderer,
          i = e.textureOptions.resolution || n.view.resolution,
          o = e.textureOptions.antialias ?? n.view.antialias,
          l = e.textureOptions.scaleMode ?? 'linear',
          d = b.getOptimalTexture(r.width, r.height, i, o);
        ((d._source.style = new je({ scaleMode: l })),
          (e.texture = d),
          e._textureBounds || (e._textureBounds = new F()),
  ...
  _updateRenderGroups(e) {
    ...
    if (
      ...
      e.structureDidChange ? E(e.childrenRenderablesToUpdate.list, 0) : ft(e, r),
      Se(e),
  ...
  _buildInstructions(e, t) {
    ...
    const n = t.renderPipes ? t : t.batch.renderer,
      i = n.renderPipes;
    (i.batch.buildStart(s),
      i.blendMode.buildStart(),
      i.colorMask.buildStart(),
      r.sortableChildren && r.sortChildren(),
      r.collectRenderablesWithEffects(s, n, null),
      i.batch.buildEnd(s),
      i.blendMode.buildEnd(s));
  }
}
Pe.extension = { type: [u.WebGLSystem, u.WebGPUSystem, u.CanvasSystem], name: 'renderGroup' };
class Re {
  constructor(e) {
    this._renderer = e;
  }
...
Re.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'sprite' };
const V = class Be {
  constructor() {
    ((this.clearBeforeRender = !0),
      (this._backgroundColor = new A(0)),
      (this.color = this._backgroundColor),
      (this.alpha = 1));
  }
  init(e) {
    ((e = { ...Be.defaultOptions, ...e }),
...
V.defaultOptions = { backgroundAlpha: 1, backgroundColor: 0, clearBeforeRender: !0 };
let mt = V;
const y = {};
O.handle(
  u.BlendMode,
...
class Ue {
  ...
  setBlendMode(e, t, r) {
    ...
    ((this._activeBlendMode = t),
      ...
      (this._isAdvanced = !!y[t]),
      this._isAdvanced && (this._beginAdvancedBlendMode(r), this._renderableList.push(e)));
  }
...
Ue.extension = { type: [u.WebGLPipes, u.WebGPUPipes, u.CanvasPipes], name: 'blendMode' };
const R = { png: 'image/png', jpg: 'image/jpeg', webp: 'image/webp' },
  N = class Ae {
    ...
    _normalizeOptions(e, t = {}) {
      return e instanceof P || e instanceof m ? { target: e, ...t } : { ...t, ...e };
    }
    async image(e) {
    ...
    async base64(e) {
      e = this._normalizeOptions(e, Ae.defaultImageOptions);
      ...
      if (s.toDataURL !== void 0) return s.toDataURL(R[t], r);
    ...
    pixels(e) {
      ...
      const t = e.target,
        r = this._renderer,
        s = t instanceof m ? t : r.textureGenerator.generateTexture(e),
    ...
    texture(e) {
      return (
        (e = this._normalizeOptions(e)),
        e.target instanceof m ? e.target : this._renderer.textureGenerator.generateTexture(e)
      );
    }
    download(e) {
      e = this._normalizeOptions(e);
...
N.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: 'extract' };
N.defaultImageOptions = { format: 'png', quality: 1 };
let vt = N;
class j extends m {
  static create(e) {
    return new j({ source: new T(e) });
  }
  resize(e, t, r) {
...
class Ge {
  ...
  generateTexture(e) {
    ...
    const i = e.frame?.copyTo(gt) || qe(s, xt).rectangle;
    ...
    return (
      this._renderer.render({ container: s, transform: l, target: o, clearColor: n }),
      o.source.updateMipmaps(),
      o
    );
  }
  destroy() {
...
Ge.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: 'textureGenerator' };
class Ie {
  constructor(e) {
    ((this._stackIndex = 0),
  ...
  bind({ size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: s, offset: n }) {
    const i = this._renderer.renderTarget.renderTarget,
      o = this._stackIndex
        ...
        : { worldTransformMatrix: new v(), worldColor: 4294967295, offset: new $e() },
      l = {
...
Ie.extension = { type: [u.WebGLSystem, u.WebGPUSystem, u.CanvasSystem], name: 'globalUniforms' };
let bt = 1;
class De {
  constructor() {
  ...
  repeat(e, t, r = !0) {
    ...
    let n = 0;
    return (
      r && ((this._offset += 1e3), (n = this._offset)),
      this._tasks.push({
        func: e,
        duration: t,
...
function Tt(a) {
  if (!se) {
    if (H.get().getNavigator().userAgent.toLowerCase().indexOf('chrome') > -1) {
      const e = [
        `%c  %c  %c  %c  %c PixiJS %c v${X} (${a}) http://www.pixijs.com/
...
`,
      ...
      globalThis.console && globalThis.console.log(`PixiJS ${X} - ${a} - http://www.pixijs.com/`);
    se = !0;
  }
}
class q {
  ...
  init(e) {
    if (e.hello) {
      ...
      (this._renderer.type === z.WEBGL && (t += ` ${this._renderer.context.webGLVersion}`), Tt(t));
    }
  }
}
q.extension = {
...
function kt(a) {
  let e = 0;
  for (let t = 0; t < a.length; t++) a[t] == null ? e++ : (a[t - e] = a[t]);
  return ((a.length -= e), a);
}
let Ct = 0;
const $ = class Ee {
      ...
      (e
        ? ((this._handler = this._renderer.scheduler.repeat(() => this.run(), this._frequency, !1)),
          (this._hashHandler = this._renderer.scheduler.repeat(() => {
            for (const t of this._managedHashes) t.context[t.hash] = yt(t.context[t.hash]);
          }, this._frequency)),
          (this._arrayHandler = this._renderer.scheduler.repeat(() => {
            for (const t of this._managedArrays) kt(t.context[t.hash]);
          }, this._frequency)))
  ...
  prerender({ container: e }) {
    ((this._now = performance.now()),
      (e.renderGroup.gcTick = Ct++),
      this._updateInstructionGCTick(e.renderGroup, e.renderGroup.gcTick));
  }
  addRenderable(e) {
    this.enabled &&
      (e._lastUsed === -1 &&
        (this._managedRenderables.push(e), e.once('destroyed', this._removeRenderable, this)),
  ...
  run() {
    ...
    for (let n = 0; n < t.length; n++) {
      ...
      const o = i.renderGroup ?? i.parentRenderGroup,
        l = o?.instructionSet?.gcTick ?? -1;
  ...
  _removeRenderable(e) {
    ...
    t >= 0 &&
      (e.off('destroyed', this._removeRenderable, this), (this._managedRenderables[t] = null));
  }
  _updateInstructionGCTick(e, t) {
    e.instructionSet.gcTick = t;
    for (const r of e.renderGroupChildren) this._updateInstructionGCTick(r, t);
  }
};
$.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: 'renderableGC', priority: 0 };
$.defaultOptions = {
...
K.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: 'textureGC' };
K.defaultOptions = {
  textureGCActive: !0,
...
const Y = class Fe {
  ...
  init(e) {
    ((e = { ...Fe.defaultOptions, ...e }),
      e.view &&
        (Ke(Ye, 'ViewSystem.view has been renamed to ViewSystem.canvas'), (e.canvas = e.view)),
      (this.screen = new w(0, 0, e.width, e.height)),
      (this.canvas = e.canvas || H.get().createCanvas()),
      (this.antialias = !!e.antialias),
      (this.texture = Te(this.canvas, e)),
      (this.renderTarget = new I({ colorTextures: [this.texture], depth: !!e.depth, isRoot: !0 })),
...
Y.extension = { type: [u.WebGLSystem, u.WebGPUSystem, u.CanvasSystem], name: 'view', priority: 0 };
Y.defaultOptions = { width: 800, height: 600, autoDensity: !1, antialias: !1 };
let wt = Y;
const Ht = [mt, Ie, q, wt, Pe, St, Ge, vt, Je, Mt, De],
  zt = [Ue, ge, Re, Me, xe, be, _e, Ce];
export {
  Lt as B,
  x as G,
  Ft as R,
