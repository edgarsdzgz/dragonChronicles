...
import {
  ...
  G as Rt,
  d as Ut,
} from './Graphics.qFUuEsXt.js';
import { S as ie, c as ae, a as Gt, b as At, B as je } from './colorToUniform.DmtBy-2V.js';
import {
  U as Y,
  B as Ne,
  k as _e,
  ...
  o as Ot,
  q as Et,
} from './DefaultBatcher.JZVzBZuM.js';
import { C as X } from './CanvasPool.6X9XNlkG.js';
class Je {
  static init(e) {
...
class Ze {
  static init(e) {
    ((e = Object.assign({ autoStart: !0, sharedTicker: !1 }, e)),
      Object.defineProperty(this, 'ticker', {
        set(t) {
          (this._ticker && this._ticker.remove(this.render, this),
            (this._ticker = t),
            t && t.add(this.render, this, Ft.LOW));
        },
        get() {
          return this._ticker;
        },
      ...
      (this._ticker = null),
      (this.ticker = e.sharedTicker ? Pe.shared : new Pe()),
...
class Ht extends Ye {
  ...
  get font() {
    return (
      k(R, 'BitmapFont.font is deprecated, please use BitmapFont.fontFamily instead.'),
      this.fontFamily
    );
  }
  get pageTextures() {
    return (
      k(R, 'BitmapFont.pageTextures is deprecated, please use BitmapFont.pages instead.'),
      this.pages
    );
  }
  get size() {
    return (
      k(R, 'BitmapFont.size is deprecated, please use BitmapFont.fontMetrics.fontSize instead.'),
...
const Vt = ['serif', 'sans-serif', 'monospace', 'cursive', 'fantasy', 'system-ui'];
function se(a) {
  const e = typeof a.fontSize == 'number' ? `${a.fontSize}px` : a.fontSize;
  let t = a.fontFamily;
  Array.isArray(a.fontFamily) || (t = a.fontFamily.split(','));
  for (let r = t.length - 1; r >= 0; r--) {
    let i = t[r].trim();
    (!/([\"\'])[^\'\"]+\1/.test(i) && !Vt.includes(i) && (i = `"${i}"`), (t[r] = i));
  }
  return `${a.fontStyle} ${a.fontVariant} ${a.fontWeight} ${e} ${t.join(',')}`;
}
const le = { willReadFrequently: !0 },
  L = class m {
    static get experimentalLetterSpacingSupported() {
      let e = m._experimentalLetterSpacingSupported;
      if (e === void 0) {
        const t = E.get().getCanvasRenderingContext2D().prototype;
        e = m._experimentalLetterSpacingSupported =
          'letterSpacing' in t || 'textLetterSpacing' in t;
      }
      return e;
    }
    constructor(e, t, r, i, s, n, o, l, c) {
      ((this.text = e),
        (this.style = t),
        (this.width = r),
        (this.height = i),
    ...
    static measureText(e = ' ', t, r = m._canvas, i = t.wordWrap) {
      ...
      for (let p = 0; p < c.length; p++) {
        const b = m._measureText(c[p], t.letterSpacing, o);
        ((u[p] = b), (d = Math.max(d, b)));
      }
      const h = t._stroke?.width || 0;
      let f = d + h;
      t.dropShadow && (f += t.dropShadow.distance);
      const x = t.lineHeight || n.fontSize;
      let _ = Math.max(x, n.fontSize + h) + (c.length - 1) * (x + t.leading);
      return (
        t.dropShadow && (_ += t.dropShadow.distance),
        new m(e, t, f, _, c, u, x + t.leading, d, n)
      );
    }
    static _measureText(e, t, r) {
      let i = !1;
      m.experimentalLetterSpacingSupported &&
        (m.experimentalLetterSpacing
          ? ((r.letterSpacing = `${t}px`), (r.textLetterSpacing = `${t}px`), (i = !0))
      ...
      if (n > 0)
        if (i) ((n -= t), (c -= t));
          ...
          const u = (m.graphemeSegmenter(e).length - 1) * t;
          ((n += u), (c += u));
        }
      return Math.max(n, c);
    }
    static _wordWrap(e, t, r = m._canvas) {
      const i = r.getContext('2d', le);
      let s = 0,
        n = '',
        o = '';
      const l = Object.create(null),
        { letterSpacing: c, whiteSpace: u } = t,
        d = m._collapseSpaces(u),
        h = m._collapseNewlines(u);
      let f = !d;
      const x = t.wordWrapWidth + c,
        _ = m._tokenize(e);
      for (let g = 0; g < _.length; g++) {
        let p = _[g];
        if (m._isNewline(p)) {
          if (!h) {
            ((o += m._addLine(n)), (f = !d), (n = ''), (s = 0));
            continue;
          }
          p = ' ';
        }
        if (d) {
          const y = m.isBreakingSpace(p),
            T = m.isBreakingSpace(n[n.length - 1]);
          if (y && T) continue;
        }
        const b = m._getFromCache(p, c, l, i);
        if (b > x)
          if (
            (n !== '' && ((o += m._addLine(n)), (n = ''), (s = 0)),
            m.canBreakWords(p, t.breakWords))
          ) {
            const y = m.wordWrapSplit(p);
            for (let T = 0; T < y.length; T++) {
              ...
              for (; y[T + P]; ) {
                const S = y[T + P];
                if (!m.canBreakChars(F, S, p, T, t.breakWords)) v += S;
                else break;
                ((F = S), P++);
              }
              T += P - 1;
              const B = m._getFromCache(v, c, l, i);
              (B + s > x && ((o += m._addLine(n)), (f = !1), (n = ''), (s = 0)),
                (n += v),
                (s += B));
            }
          } else {
            n.length > 0 && ((o += m._addLine(n)), (n = ''), (s = 0));
            const y = g === _.length - 1;
            ((o += m._addLine(p, !y)), (f = !1), (n = ''), (s = 0));
          }
        else
          (b + s > x && ((f = !1), (o += m._addLine(n)), (n = ''), (s = 0)),
            (n.length > 0 || !m.isBreakingSpace(p) || f) && ((n += p), (s += b)));
      }
      return ((o += m._addLine(n, !1)), o);
    }
...
`
    ...
    static _tokenize(e) {
      ...
      for (let i = 0; i < e.length; i++) {
        const s = e[i],
          n = e[i + 1];
        if (m.isBreakingSpace(s, n) || m._isNewline(s)) {
          (r !== '' && (t.push(r), (r = '')),
            s === '\r' &&
            n ===
              `
...
`),
    ...
    static measureFont(e) {
      if (m._fonts[e]) return m._fonts[e];
      const t = m._context;
      t.font = e;
      const r = t.measureText(m.METRICS_STRING + m.BASELINE_SYMBOL),
        i = {
    ...
    static get _canvas() {
      if (!m.__canvas) {
        ...
        try {
          ...
          if (t.getContext('2d', le)?.measureText) return ((m.__canvas = t), t);
          e = E.get().createCanvas();
        } catch {
          e = E.get().createCanvas();
        }
    ...
    static get _context() {
      return (m.__context || (m.__context = m._canvas.getContext('2d', le)), m.__context);
    }
  };
L.METRICS_STRING = '|ÉqÅ';
L.BASELINE_SYMBOL = 'M';
L.BASELINE_MULTIPLIER = 1.4;
L.HEIGHT_MULTIPLIER = 2;
L.graphemeSegmenter = (() => {
  if (typeof Intl?.Segmenter == 'function') {
    const a = new Intl.Segmenter();
    return (e) => {
      const t = a.segment(e),
        r = [];
      let i = 0;
      for (const s of t) r[i++] = s.segment;
      return r;
    };
  }
  return (a) => [...a];
})();
L.experimentalLetterSpacing = !1;
L._fonts = {};
L._newlines = [10, 13];
L._breakingSpaces = [
...
function Xt(a, e, t) {
  if (!a) return t;
  for (const r of a) e[t++] = r.uid;
  return t;
}
function et(a, e, t) {
  return (a && ((e[t++] = a.color), (e[t++] = a.alpha), (e[t++] = a.fill?.styleKey)), t);
}
function jt(a, e, t) {
  return (
    a &&
...
function Nt(a, e, t) {
  return (
    a &&
      ...
      (e[t++] = a.blur),
      (e[t++] = a.distance),
      (e[t++] = D.shared.setValue(a.color).toNumber())),
    t
  );
}
const Se = class V extends Ye {
  constructor(e = {}) {
    (super(), $t(e));
    const t = { ...V.defaultTextStyle, ...e };
    for (const r in t) {
      const i = r;
      this[i] = t[r];
    }
  ...
  set dropShadow(e) {
    (e !== null && typeof e == 'object'
      ? (this._dropShadow = this._createProxy({ ...V.defaultDropShadow, ...e }))
      : (this._dropShadow = e ? this._createProxy({ ...V.defaultDropShadow }) : null),
      this.update());
  }
  get fontFamily() {
  ...
  set fill(e) {
    e !== this._originalFill &&
      ...
      this._isFillStyle(e) &&
        (this._originalFill = this._createProxy({ ...H.defaultFillStyle, ...e }, () => {
          this._fill = Be({ ...this._originalFill }, H.defaultFillStyle);
        })),
      (this._fill = Be(e === 0 ? 'black' : e, H.defaultFillStyle)),
      this.update());
  }
  get stroke() {
  ...
  set stroke(e) {
    e !== this._originalStroke &&
      ...
      this._isFillStyle(e) &&
        (this._originalStroke = this._createProxy({ ...H.defaultStrokeStyle, ...e }, () => {
          this._stroke = ke({ ...this._originalStroke }, H.defaultStrokeStyle);
        })),
      (this._stroke = ke(e, H.defaultStrokeStyle)),
      this.update());
  }
  _generateKey() {
    return ((this._styleKey = Yt(this)), this._styleKey);
  }
  update() {
    ((this._styleKey = null), this.emit('update', this));
  }
  reset() {
    const e = V.defaultTextStyle;
  ...
  destroy(e = !1) {
    if ((this.removeAllListeners(), typeof e == 'boolean' ? e : e?.texture)) {
      const r = typeof e == 'boolean' ? e : e?.textureSource;
  ...
  _createProxy(e, t) {
    return new Proxy(e, { set: (r, i, s) => ((r[i] = s), t?.(i, s), this.update(), !0) });
  }
  _isFillStyle(e) {
    return (e ?? null) !== null && !(D.isColorLike(e) || e instanceof re || e instanceof xe);
  }
};
Se.defaultDropShadow = { alpha: 1, angle: Math.PI / 6, blur: 0, color: 'black', distance: 5 };
Se.defaultTextStyle = {
  align: 'left',
  breakWords: !1,
  dropShadow: null,
...
function $t(a) {
  ...
  if (e.strokeThickness !== void 0) {
    k(R, 'strokeThickness is now a part of stroke');
    const t = e.stroke;
    let r = {};
    if (D.isColorLike(t)) r.color = t;
    else if (t instanceof re || t instanceof xe) r.fill = t;
    else if (Object.hasOwnProperty.call(t, 'color') || Object.hasOwnProperty.call(t, 'fill')) r = t;
    else throw new Error('Invalid stroke value.');
    a.stroke = { ...r, width: e.strokeThickness };
  }
  if (Array.isArray(e.fillGradientStops)) {
    if (
      (k(R, 'gradient fill is now a fill pattern: `new FillGradient(...)`'),
      !Array.isArray(e.fill) || e.fill.length === 0)
    )
      throw new Error('Invalid fill value. Expected an array of colors for gradient fill.');
    e.fill.length !== e.fillGradientStops.length &&
      K('The number of fill colors must match the number of fill gradient stops.');
    const t = new re({ start: { x: 0, y: 0 }, end: { x: 0, y: 1 }, textureSpace: 'local' }),
      r = e.fillGradientStops.slice(),
      i = e.fill.map((s) => D.shared.setValue(s).toNumber());
    (r.forEach((s, n) => {
      t.addColorStop(s, i[n]);
    }),
      (a.fill = { fill: t }));
  }
}
const Re = 1e5;
function ne(a, e, t, r = 0) {
  if (a.texture === M.WHITE && !a.fill)
    return D.shared
      .setValue(a.color)
      .setAlpha(a.alpha ?? 1)
      .toHexa();
  if (a.fill) {
    if (a.fill instanceof xe) {
      const i = a.fill,
        s = e.createPattern(i.texture.source.resource, 'repeat'),
        n = i.transform.copyTo(U.shared);
      return (n.scale(i.texture.frame.width, i.texture.frame.height), s.setTransform(n), s);
    } else if (a.fill instanceof re) {
      const i = a.fill,
        s = i.type === 'linear',
        n = i.textureSpace === 'local';
      let o = 1,
        l = 1;
      n && t && ((o = t.width + r), (l = t.height + r));
      let c,
        u = !1;
      if (s) {
        const { start: d, end: h } = i;
        ((c = e.createLinearGradient(d.x * o, d.y * l, h.x * o, h.y * l)),
          (u = Math.abs(h.x - d.x) < Math.abs((h.y - d.y) * 0.1)));
      } else {
        const { center: d, innerRadius: h, outerCenter: f, outerRadius: x } = i;
        c = e.createRadialGradient(d.x * o, d.y * l, h * o, f.x * o, f.y * l, x * o);
      }
      if (u && n && t) {
        ...
        for (let h = 0; h < t.lines.length; h++) {
          ...
          i.colorStops.forEach((x) => {
            const _ = f + x.offset * d;
            c.addColorStop(Math.floor(_ * Re) / Re, D.shared.setValue(x.color).toHex());
          });
        }
      } else
        i.colorStops.forEach((d) => {
          c.addColorStop(d.offset, D.shared.setValue(d.color).toHex());
        });
      return c;
    }
  } else {
    const i = e.createPattern(a.texture.source.resource, 'repeat'),
      s = a.matrix.copyTo(U.shared);
    return (s.scale(a.texture.frame.width, a.texture.frame.height), i.setTransform(s), i);
  }
  return (K('FillStyle not recognised', a), 'red');
}
const tt = class rt extends Ht {
  constructor(e) {
    (super(),
      (this.resolution = 1),
      (this.pages = []),
    ...
    (t.overrideSize
      ...
      t.textureStyle &&
        (this._textureStyle = t.textureStyle instanceof $ ? t.textureStyle : new $(t.textureStyle)),
      (this.fontMetrics = z.measureFont(s)),
      (this.lineHeight = r.lineHeight || this.fontMetrics.fontSize || r.fontSize));
  }
  ensureCharacters(e) {
    const t = z
      .graphemeSegmenter(e)
      .filter((g) => !this._currentChars.includes(g))
      .filter((g, p, b) => b.indexOf(g) === p);
    if (!t.length) return;
    ...
    const d = this.baseRenderedFontSize / this.baseMeasurementFontSize,
      h = this._padding * d;
    let f = !1;
    const x = i.width / this.resolution,
      _ = i.height / this.resolution;
    for (let g = 0; g < t.length; g++) {
      const p = t[g],
        b = z.measureText(p, o, i, !1);
      b.lineHeight = b.height;
      const y = b.width * d,
        T = Math.ceil((o.fontStyle === 'italic' ? 2 : 1) * y),
        v = b.height * d,
        F = T + h * 2,
        P = v + h * 2;
      if (
...
` &&
          ...
          p !== '	' &&
          p !== ' ' &&
          ((f = !0), (u = Math.ceil(Math.max(P, u)))),
        l + F > x && ((c += u), (u = P), (l = 0), c + u > _))
      ) {
        n.update();
        const S = this._nextPage();
        ((i = S.canvasAndContext.canvas),
          (s = S.canvasAndContext.context),
          (n = S.texture.source),
          (l = 0),
          (c = 0),
          (u = 0));
      }
      const B = y / d - (o.dropShadow?.distance ?? 0) - (o._stroke?.width ?? 0);
      if (
        ((this.chars[p] = {
          id: p.codePointAt(0),
        ...
        this._drawGlyph(s, b, l + h, c + h, d, o);
        const S = n.width * d,
          q = n.height * d,
          oe = new ee((l / S) * n.width, (c / q) * n.height, (F / S) * n.width, (P / q) * n.height);
        ((this.chars[p].texture = new M({ source: n, frame: oe })), (l += Math.ceil(F)));
      }
    }
    (n.update(),
      (this._currentX = l),
  ...
  _applyKerning(e, t) {
    ...
    for (let i = 0; i < e.length; i++) {
      ...
      for (let n = 0; n < this._currentChars.length; n++) {
        ...
        let u = t.measureText(s + o).width,
          d = u - (l + c);
        (d && (this.chars[s].kerning[o] = d),
          (u = t.measureText(s + o).width),
          (d = u - (l + c)),
          d && (this.chars[o].kerning[s] = d));
      }
    }
  }
  _nextPage() {
    ...
    const e = this.resolution,
      t = X.getOptimalCanvasAndContext(this._textureSize, this._textureSize, e);
    ...
    const s = { canvasAndContext: t, texture: i };
  ...
  _setupContext(e, t, r) {
    ...
    if (
      (i &&
        ...
        (e.strokeStyle = ne(i, e))),
      t._fill && (e.fillStyle = ne(t._fill, e)),
      t.dropShadow)
    ) {
      const n = t.dropShadow,
        o = D.shared.setValue(n.color).toArray(),
        l = n.blur * r,
        c = n.distance * r;
      ((e.shadowColor = `rgba(${o[0] * 255},${o[1] * 255},${o[2] * 255},${n.alpha})`),
        (e.shadowBlur = l),
        (e.shadowOffsetX = Math.cos(n.angle) * c),
        (e.shadowOffsetY = Math.sin(n.angle) * c));
    } else
  ...
  _drawGlyph(e, t, r, i, s, n) {
    const o = t.text,
      ...
      x = t.lineHeight * s;
    let _ = !1;
    n.stroke && u && ((_ = !0), e.strokeText(o, d, h + x - f));
    const { shadowBlur: g, shadowOffsetX: p, shadowOffsetY: b } = e;
    (n._fill &&
      (_ && ((e.shadowBlur = 0), (e.shadowOffsetX = 0), (e.shadowOffsetY = 0)),
      e.fillText(o, d, h + x - f)),
      _ && ((e.shadowBlur = g), (e.shadowOffsetX = p), (e.shadowOffsetY = b)));
  }
  destroy() {
    super.destroy();
...
tt.defaultOptions = { textureSize: 512, style: new j(), mipmap: !0 };
let Ue = tt;
function it(a, e, t, r) {
  const i = {
    width: 0,
  ...
  const l = { width: 0, start: 0, index: 0, positions: [], chars: [] },
    ...
    u = e.letterSpacing * c,
    d = e.wordWrapWidth * c,
    h = e.lineHeight ? e.lineHeight * c : t.lineHeight,
    f = e.wordWrap && e.breakWords,
    x = (p) => {
      const b = s.width;
      for (let y = 0; y < l.index; y++) {
        const T = p.positions[y];
        (s.chars.push(p.chars[y]), s.charPositions.push(T + b));
      }
    ...
    _ = () => {
      ...
      if (r) {
        let b = s.chars[p];
        for (; b === ' '; ) ((s.width -= t.chars[b].xAdvance), (b = s.chars[--p]));
      }
...
` ||
      ...
      if (
        (!o && e.wordWrap && g(s.width + l.width)
          ? (_(), x(l), y || s.charPositions.push(0))
          : ((l.start = s.width), x(l), y || s.charPositions.push(0)),
        b === '\r' ||
          b ===
            `
`)
        ...
        const B = T.xAdvance + (T.kerning[n] || 0) + u;
        ((s.width += B),
          (s.spaceWidth = B),
      ...
      const P = T.kerning[n] || 0,
        B = T.xAdvance + P + u;
      (f && g(s.width + l.width + B) && (x(l), _()),
        (l.positions[l.index++] = l.width + P),
        l.chars.push(b),
        (l.width += B));
    }
    n = b;
  ...
  return (
    _(),
    e.align === 'center' ? Kt(i) : e.align === 'right' ? qt(i) : e.align === 'justify' && Qt(i),
    i
  );
}
function Kt(a) {
...
function Qt(a) {
  ...
  for (let t = 0; t < a.lines.length; t++) {
    ...
    for (let u = 0; u < r.charPositions.length; u++)
      (u === s && ((s = r.spacesIndex[i++]), (n += c)), (r.charPositions[u] += n));
  }
}
function Jt(a) {
  if (a === '') return [];
  ...
  for (let t = 0, r = a.length; t < r; t++) {
    ...
    if (Array.isArray(i)) {
      ...
      for (let o = s, l = n; o <= l; o++) e.push(String.fromCharCode(o));
...
class Zt {
  ...
  getFont(e, t) {
    let r = `${t.fontFamily}-bitmap`,
      i = !0;
    if (t._fill.fill && !t._stroke) ((r += t._fill.fill.styleKey), (i = !1));
    else if (t._stroke || t.dropShadow) {
      let n = t.styleKey;
      ((n = n.substring(0, n.lastIndexOf('-'))), (r = `${n}-bitmap`), (i = !1));
    }
    if (!G.has(r)) {
      const n = Object.create(t);
      n.lineHeight = 0;
      const o = new Ue({ style: n, overrideFill: i, overrideSize: !0, ...this.defaultOptions });
      (J++,
        J > 50 &&
          K(
            'BitmapText',
            `You have dynamically created ${J} bitmap fonts, this can be inefficient. Try pre installing your font styles using \`BitmapFont.install({name:"style1", style})\``,
          ),
        o.once('destroy', () => {
          (J--, G.remove(r));
        }),
  ...
  install(...e) {
    ...
    return (
      ...
      G.set(`${r}-bitmap`, o),
      o.once('destroy', () => G.remove(`${r}-bitmap`)),
      o
    );
  }
  uninstall(e) {
...
st.extension = { type: [w.WebGLPipes, w.WebGPUPipes, w.CanvasPipes], name: 'filter' };
function tr(a, e) {
  e.clear();
  const t = e.matrix;
...
class nt {
  constructor(e) {
    ((this._filterStackIndex = 0),
      ...
      (this._globalFilterBindGroup = new Ne({})),
      (this.renderer = e));
  }
  ...
  push(e) {
    ...
    ((i.skip = !1),
      ...
      (i.outputRenderSurface = t.renderTarget.renderSurface));
    ...
    if (
      ...
      this._calculateFilterBounds(i, t.renderTarget.rootViewPort, o, n, 1),
      i.skip)
    )
      return;
    ...
    let d = 0,
      h = 0;
    (c && ((d = c.bounds.minX), (h = c.bounds.minY)),
      this._calculateGlobalFrame(i, d, h, u, s.width, s.height),
  ...
  generateFilteredTexture({ texture: e, filters: t }) {
    ...
    const o = r.bounds;
    if ((o.addRect(e.frame), this._calculateFilterBounds(r, o.rectangle, n, s, 0), r.skip))
      return e;
    const l = s;
    (this._calculateGlobalFrame(r, 0, 0, l, i.width, i.height),
      (r.outputRenderSurface = A.getOptimalTexture(o.width, o.height, r.resolution, r.antialias)),
      (r.backTexture = M.EMPTY),
      (r.inputTexture = e),
  ...
  applyFilter(e, t, r, i) {
    ...
    (this._updateFilterUniforms(t, r, n, d, h, u, l, i), this._setupBindGroupsAndRender(e, t, s));
  }
  ...
  _setupBindGroupsAndRender(e, t, r) {
    ...
    (this._globalFilterBindGroup.setResource(t.source, 1),
      ...
      r.encoder.draw({ geometry: rr, shader: e, state: e._state, topology: 'triangle-list' }),
      r.type === be.WEBGL && r.renderTarget.finishRenderPass());
  }
  _setupFilterTextures(e, t, r, i) {
    if (((e.backTexture = M.EMPTY), e.blendRequired)) {
      r.renderTarget.finishRenderPass();
      const s = r.renderTarget.getRenderTarget(e.outputRenderSurface);
      e.backTexture = this.getBackTexture(s, t, i?.bounds);
    }
    ((e.inputTexture = A.getOptimalTexture(t.width, t.height, e.resolution, e.antialias)),
      r.renderTarget.bind(e.inputTexture, !0),
      r.globalUniforms.push({ offset: t }));
  }
  _calculateGlobalFrame(e, t, r, i, s, n) {
    const o = e.globalFrame;
    ((o.x = t * i), (o.y = r * i), (o.width = s * i), (o.height = n * i));
  }
  _updateFilterUniforms(e, t, r, i, s, n, o, l) {
    const c = this._filterGlobalUniforms.uniforms,
      ...
      x = c.uGlobalFrame,
      _ = c.uOutputTexture;
    (o ? ((u[0] = r.bounds.minX - i), (u[1] = r.bounds.minY - s)) : ((u[0] = 0), (u[1] = 0)),
      (u[2] = e.frame.width),
      (u[3] = e.frame.height),
      (d[0] = e.source.width),
      (d[1] = e.source.height),
    ...
    ((x[0] = i * n),
      (x[1] = s * n),
      (x[2] = g.source.width * n),
      (x[3] = g.source.height * n),
      t instanceof M && (t.source.resource = null));
    const p = this.renderer.renderTarget.getRenderTarget(t);
    (this.renderer.renderTarget.bind(t, !!l),
      t instanceof M
        ? ((_[0] = t.frame.width), (_[1] = t.frame.height))
        : ((_[0] = p.width), (_[1] = p.height)),
      (_[2] = p.isRoot ? -1 : 1),
  ...
  _applyFiltersToTexture(e, t) {
    ...
    if (
      ...
      s[0].apply(this, r, e.outputRenderSurface, t);
    else {
      let n = e.inputTexture;
      const o = A.getOptimalTexture(i.width, i.height, n.source._resolution, !1);
      let l = o,
        c = 0;
      for (c = 0; c < s.length - 1; ++c) {
        s[c].apply(this, n, l, !0);
        const d = n;
        ((n = l), (l = d));
      }
      (s[c].apply(this, n, e.outputRenderSurface, t), A.returnTexture(o));
    }
  }
  _calculateFilterBounds(e, t, r, i, s) {
    ...
    for (let _ = 0; _ < l.length; _++) {
      const g = l[_];
      if (
        ((c = Math.min(c, g.resolution === 'inherit' ? i : g.resolution)),
        (u += g.padding),
        g.antialias === 'off' ? (d = !1) : g.antialias === 'inherit' && d && (d = r),
        g.clipToViewport || (x = !1),
        !!!(g.compatibleRenderers & n.type))
      ) {
        f = !1;
        break;
      }
      if (g.blendRequired && !(n.backBuffer?.useBackBuffer ?? !0)) {
        (K(
      ...
      ((f = g.enabled || f), h || (h = g.blendRequired));
    }
    if (!f) {
      e.skip = !0;
      return;
    ...
    if (
      (x && o.fitBounds(0, t.width / i, 0, t.height / i),
      o
        .scale(c)
        .ceil()
        .scale(1 / c)
    ...
    ((e.antialias = d), (e.resolution = c), (e.blendRequired = h));
  }
  _popFilterData() {
  ...
  _pushFilterData() {
    ...
    return (
      e || (e = this._filterStack[this._filterStackIndex] = new ir()),
      this._filterStackIndex++,
      e
    );
  }
}
nt.extension = { type: [w.WebGLSystem, w.WebGPUSystem], name: 'filter' };
const at = class ot extends _e {
  constructor(...e) {
    let t = e[0] ?? {};
    (t instanceof Float32Array &&
      (k(R, 'use new MeshGeometry({ positions, uvs, indices }) instead'),
      (t = { positions: t, uvs: e[1], indices: e[2] })),
      (t = { ...ot.defaultOptions, ...t }));
...
at.defaultOptions = { topology: 'triangle-list', shrinkBuffersToFit: !1 };
let Te = at,
  O = null,
  I = null;
function sr(a, e) {
  (O ||
    ((O = E.get().createCanvas(256, 128)),
    (I = O.getContext('2d', { willReadFrequently: !0 })),
    (I.globalCompositeOperation = 'copy'),
    (I.globalAlpha = 1)),
    (O.width < a || O.height < e) && ((O.width = Fe(a)), (O.height = Fe(e))));
}
function Ge(a, e, t) {
  for (let r = 0, i = 4 * t * e; r < e; ++r, i += 4) if (a[i + 3] !== 0) return !1;
  return !0;
}
function Ae(a, e, t, r, i) {
  const s = 4 * e;
  for (let n = r, o = r * s + 4 * t; n <= i; ++n, o += s) if (a[o + 3] !== 0) return !1;
  return !0;
}
function nr(...a) {
  let e = a[0];
  e.canvas || (e = { canvas: a[0], resolution: a[1] });
  const { canvas: t } = e,
    r = Math.min(e.resolution ?? 1, 1),
    i = e.width ?? t.width,
    s = e.height ?? t.height;
  let n = e.output;
  if ((sr(i, s), !I)) throw new TypeError('Failed to get canvas 2D context');
  I.drawImage(t, 0, 0, i, s, 0, 0, i * r, s * r);
  const l = I.getImageData(0, 0, i, s).data;
  let c = 0,
    u = 0,
    d = i - 1,
    h = s - 1;
  for (; u < s && Ge(l, i, u); ) ++u;
  if (u === s) return ee.EMPTY;
  for (; Ge(l, i, h); ) --h;
  for (; Ae(l, i, c, u, h); ) ++c;
  for (; Ae(l, i, d, u, h); ) --d;
  return (
    ...
    I.strokeRect(c, u, d - c, h - u),
    (I.globalCompositeOperation = 'copy'),
    n ?? (n = new ee()),
    n.set(c / r, u / r, (d - c) / r, (h - u) / r),
    n
  );
}
const We = new ee();
class ar {
  getCanvasAndContext(e) {
    const { text: t, style: r, resolution: i = 1 } = e,
      s = r._getFinalPadding(),
      n = z.measureText(t || ' ', r),
      o = Math.ceil(Math.ceil(Math.max(1, n.width) + s * 2) * i),
      l = Math.ceil(Math.ceil(Math.max(1, n.height) + s * 2) * i),
      c = X.getOptimalCanvasAndContext(o, l);
    this._renderTextToCanvas(t, r, s, i, c);
    const u = r.trim
      ? nr({ canvas: c.canvas, width: o, height: l, resolution: 1, output: We })
      : We.set(0, 0, o, l);
    return { canvasAndContext: c, frame: u };
  }
  returnCanvasAndContext(e) {
    X.returnCanvasAndContext(e);
  }
  _renderTextToCanvas(e, t, r, i, s) {
    const { canvas: n, context: o } = s,
      l = se(t),
      c = z.measureText(e || ' ', t),
      u = c.lines,
      d = c.lineHeight,
      ...
      x = c.fontProperties,
      _ = n.height;
    if ((o.resetTransform(), o.scale(i, i), (o.textBaseline = t.textBaseline), t._stroke?.width)) {
      const y = t._stroke;
      ((o.lineWidth = y.width),
        (o.miterLimit = y.miterLimit),
        (o.lineJoin = y.join),
        (o.lineCap = y.cap));
    }
    o.font = l;
    ...
    for (let y = 0; y < b; ++y) {
      const T = t.dropShadow && y === 0,
        v = T ? Math.ceil(Math.max(1, _) + r * 2) : 0,
        F = v * i;
      if (T) {
        ...
        const S = t.dropShadow,
          q = S.color,
          oe = S.alpha;
        o.shadowColor = D.shared.setValue(q).setAlpha(oe).toRgbaString();
        const Pt = S.blur * i,
          Ce = S.distance * i;
        ((o.shadowBlur = Pt),
          (o.shadowOffsetX = Math.cos(S.angle) * Ce),
          (o.shadowOffsetY = Math.sin(S.angle) * Ce + F));
      } else {
        if (((o.fillStyle = t._fill ? ne(t._fill, o, c, r * 2) : null), t._stroke?.width)) {
          const S = t._stroke.width * 0.5 + r * 2;
          o.strokeStyle = ne(t._stroke, o, c, S);
        }
        o.shadowColor = 'black';
      }
      let P = (d - x.fontSize) / 2;
      d - x.fontSize < 0 && (P = 0);
      const B = t._stroke?.width ?? 0;
      for (let S = 0; S < u.length; S++)
        ((g = B / 2),
          (p = B / 2 + S * d + x.ascent + P),
          t.align === 'right' ? (g += f - h[S]) : t.align === 'center' && (g += (f - h[S]) / 2),
          t._stroke?.width && this._drawLetterSpacing(u[S], t, s, g + r, p + r - v, !0),
          t._fill !== void 0 && this._drawLetterSpacing(u[S], t, s, g + r, p + r - v));
    }
  }
  _drawLetterSpacing(e, t, r, i, s, n = !1) {
    ...
    let c = !1;
    if (
      (z.experimentalLetterSpacingSupported &&
        (z.experimentalLetterSpacing
          ? ((o.letterSpacing = `${l}px`), (o.textLetterSpacing = `${l}px`), (c = !0))
    ...
    for (let x = 0; x < d.length; ++x) {
      const _ = d[x];
      n ? o.strokeText(_, u, s) : o.fillText(_, u, s);
      let g = '';
      for (let p = x + 1; p < d.length; ++p) g += d[p];
      ((f = o.measureText(g).width), (u += h - f + l), (h = f));
    }
  }
}
const ce = new ar(),
...
class lt {
  constructor() {
    ((this.svgRoot = document.createElementNS(ze, 'svg')),
      (this.foreignObject = document.createElementNS(ze, 'foreignObject')),
      (this.domElement = document.createElementNS(De, 'div')),
      (this.styleElement = document.createElementNS(De, 'style')));
...
function or(a, e, t, r) {
  ...
  ((i.innerHTML = `<style>${e.cssStyle};</style><div style='padding:0'>${a}</div>`),
...
class ct {
  ...
  execute(e) {
    ...
    ((n.uTransformMatrix = e.groupTransform),
      ...
      ae(e.groupColorAlpha, n.uColor, 0),
...
ct.extension = { type: [w.WebGLPipes, w.WebGPUPipes, w.CanvasPipes], name: 'graphics' };
const dt = class ut extends Te {
  constructor(...e) {
    super({});
    let t = e[0] ?? {};
    (typeof t == 'number' &&
  ...
  build(e) {
    ...
    for (let d = 0; d < t; d++) {
      ...
      (r.push(h * l, f * c), i.push(h / n, f / o));
    }
    const u = n * o;
    for (let d = 0; d < u; d++) {
      const h = d % n,
        f = (d / n) | 0,
        x = f * this.verticesX + h,
        _ = f * this.verticesX + h + 1,
...
dt.defaultOptions = { width: 100, height: 100, verticesX: 10, verticesY: 10 };
let cr = dt;
class ve {
  constructor() {
    ...
    return (
      s.isSimple ||
        ...
        (this._textureMatrixUpdateId !== s._updateID || this._uvUpdateId !== t._updateID) &&
          ((!i || i.length < r.length) && (i = this._transformedUvs = new Float32Array(r.length)),
...
class ht {
  constructor(e, t) {
    ((this.localUniforms = new Y({
      ...
      (this.localUniformsBindGroup = new Ne({ 0: this.localUniforms })),
      (this.renderer = e),
      (this._adaptor = t),
      this._adaptor.init());
  }
  ...
  addRenderable(e, t) {
    ...
    if (
      (e.didViewUpdate &&
        ((i.indexSize = e._geometry.indices?.length),
        (i.vertexSize = e._geometry.positions?.length)),
      i.batched)
    ) {
  ...
  execute(e) {
    if (!e.isRenderable) return;
    e.state.blendMode = ye(e.groupBlendMode, e.texture._source);
    ...
    ((t.uniforms.uTransformMatrix = e.groupTransform),
      ...
      t.update(),
      ae(e.groupColorAlpha, t.uniforms.uColor, 0),
      this._adaptor.execute(this, e));
  }
  _getMeshData(e) {
    var t, r;
    return (
      (t = e._gpuData)[(r = this.renderer.uid)] || (t[r] = new Ie()),
...
ht.extension = { type: [w.WebGLPipes, w.WebGPUPipes, w.CanvasPipes], name: 'mesh' };
class dr {
  execute(e, t) {
    const r = e.state,
      i = e.renderer,
    ...
    const c =
      o.geometry.indexBuffer.data.BYTES_PER_ELEMENT === 2 ? n.UNSIGNED_SHORT : n.UNSIGNED_INT;
...
function hr(a) {
  return { dynamicUpdate: Ee(a, !0), staticUpdate: Ee(a, !1) };
}
function Ee(a, e) {
  const t = [];
  t.push(`
...
class fr {
  constructor(e) {
    ...
    for (const u in r) {
      const d = r[u],
        h = ge(d.format);
      d.dynamic ? (s += h.stride) : (i += h.stride);
    }
    ((this._dynamicStride = s / 4),
      (this._staticStride = i / 4),
      (this.staticAttributeBuffer = new Q(t * 4 * i)),
      (this.dynamicAttributeBuffer = new Q(t * 4 * s)),
      (this.indexBuffer = Oe(t)));
    const n = new _e();
    let o = 0,
      l = 0;
    ...
    for (const u in r) {
      const d = r[u],
        h = ge(d.format);
      d.dynamic
        ? (n.addAttribute(d.attributeName, {
  ...
  update(e, t) {
    e.length > this._size &&
      ...
      (this.staticAttributeBuffer = new Q(this._size * this._staticStride * 4 * 4)),
      (this.dynamicAttributeBuffer = new Q(this._size * this._dynamicStride * 4 * 4)),
      (this.indexBuffer = Oe(this._size)),
...
class xr extends we {
  constructor() {
    const e = Wt.from({ vertex: mr, fragment: gr }),
      t = zt.from({
        fragment: { source: He, entryPoint: 'mainFragment' },
        vertex: { source: He, entryPoint: 'mainVertex' },
      });
    super({
      glProgram: e,
      gpuProgram: t,
      resources: {
        ...
        uniforms: {
          ...
          uColor: { value: new D(16777215), type: 'vec4<f32>' },
...
class ft {
  ...
  _initBuffer(e) {
    return (
      (e._gpuData[this.renderer.uid] = new fr({
  ...
  execute(e) {
    ...
    (i.update(t, e._childrenDirty),
      (e._childrenDirty = !1),
      (s.blendMode = ye(e.blendMode, e.texture._source)));
...
pt.extension = { type: [w.WebGLPipes], name: 'particle' };
class gt extends ft {
  constructor(e) {
    super(e, new ur());
  }
}
gt.extension = { type: [w.WebGPUPipes], name: 'particle' };
const mt = class xt extends cr {
  constructor(e = {}) {
    ((e = { ...xt.defaultOptions, ...e }),
  ...
  updatePositions() {
    const e = this.positions,
      ...
      g = c * r;
    ((e[0] = e[8] = e[16] = e[24] = -_),
      (e[2] = e[10] = e[18] = e[26] = i * x - _),
      (e[4] = e[12] = e[20] = e[28] = t - s * x - _),
      (e[6] = e[14] = e[22] = e[30] = t - _),
      (e[1] = e[3] = e[5] = e[7] = -g),
      (e[9] = e[11] = e[13] = e[15] = n * x - g),
      (e[17] = e[19] = e[21] = e[23] = r - o * x - g),
...
class _t {
  ...
  _initGPUSprite(e) {
    const t = (e._gpuData[this._renderer.uid] = new br()),
      r = t;
    return (
      (r.renderable = e),
...
_t.extension = { type: [w.WebGLPipes, w.WebGPUPipes, w.CanvasPipes], name: 'nineSliceSprite' };
const yr = {
    name: 'tiling-bit',
    vertex: {
      header: `
...
class Sr extends we {
  constructor() {
    (de ?? (de = $e({ name: 'tiling-sprite-shader', bits: [Gt, yr, Ke] })),
      ue ?? (ue = qe({ name: 'tiling-sprite-shader', bits: [At, wr, Qe] })));
    const e = new Y({
  ...
  updateUniforms(e, t, r, i, s, n) {
    ...
    (d.set((r.a * l) / e, (r.b * l) / t, (r.c * c) / e, (r.d * c) / t, r.tx / e, r.ty / t),
      d.invert(),
...
function Cr(a, e, t, r) {
  ...
  for (t *= e; i < s; ) {
    const h = a[t],
      f = a[t + 1];
    ((a[t] = n * h + l * f + u), (a[t + 1] = o * h + c * f + d), (t += e), i++);
  }
}
function Pr(a, e) {
  const t = a.texture,
  ...
  let s = 0,
    n = 0;
  (a.applyAnchorToTexture && ((s = a.anchor.x), (n = a.anchor.y)),
    (e[0] = e[6] = -s),
    (e[2] = e[4] = 1 - s),
    (e[1] = e[3] = -n),
    (e[5] = e[7] = 1 - n));
...
class bt {
  constructor(e) {
    ((this._state = ie.default2d), (this._renderer = e));
  }
  validateRenderable(e) {
  ...
  addRenderable(e, t) {
    ...
    if (n) {
      ...
      (e.didViewUpdate &&
        ...
        r.addToBatch(o, t));
    } else (r.break(t), i.shader || (i.shader = new Sr()), this.updateRenderable(e), t.add(e));
  }
  execute(e) {
    ...
    ((r.uTransformMatrix = e.groupTransform),
      ...
      ae(e.groupColorAlpha, r.uColor, 0),
      (this._state.blendMode = ye(e.groupBlendMode, e.texture._source)),
      this._renderer.encoder.draw({ geometry: Z, shader: t, state: this._state }));
  }
  updateRenderable(e) {
    const t = this._getTilingSpriteData(e),
      { canBatch: r } = t;
  ...
  _updateCanBatch(e) {
    ...
    let i = !0;
    return (
      this._renderer.type === be.WEBGL && (i = this._renderer.context.supports.nonPowOf2wrapping),
      (t.canBatch = r.textureMatrix.isSimple && (i || r.source.isPowerOfTwo)),
      t.canBatch
    );
  }
}
bt.extension = { type: [w.WebGLPipes, w.WebGPUPipes, w.CanvasPipes], name: 'tilingSprite' };
const Br = {
...
class Ur extends we {
  constructor(e) {
    ...
    (he ?? (he = $e({ name: 'sdf-shader', bits: [Dt, Lt(e), Br, Mr, Ke] })),
      fe ?? (fe = qe({ name: 'sdf-shader', bits: [It, Ot(e), kr, Rr, Qe] })),
      super({
        glProgram: fe,
        gpuProgram: he,
        resources: { localUniforms: t, batchSamplers: Et(e) },
      }));
  }
}
class Gr extends Rt {
...
class yt {
  ...
  _updateContext(e, t) {
    const { context: r } = t,
      i = er.getFont(e.text, e._style);
    (r.clear(),
      i.distanceField.type !== 'none' &&
        (r.customShader || (r.customShader = new Ur(this._renderer.limits.maxBatchableTextures))));
    const s = z.graphemeSegmenter(e.text),
      n = e._style;
    ...
    (n._stroke && ((d += n._stroke.width / u), (h += n._stroke.width / u)),
      r.translate(-e._anchor._x * d - c, -e._anchor._y * h - c).scale(u, u));
    const f = i.applyFillAsTint ? n._fill.color : 16777215;
    let x = i.fontMetrics.fontSize,
      _ = i.lineHeight;
    n.lineHeight && ((x = n.fontSize / u), (_ = n.lineHeight / u));
    let g = (_ - x) / 2;
    g - i.baseLineOffset < 0 && (g = 0);
      ...
      for (let y = 0; y < b.charPositions.length; y++) {
        ...
        if (v?.texture) {
          ...
          r.texture(
            F,
            f || 'black',
            Math.round(b.charPositions[y] + v.xOffset),
            Math.round(o + v.yOffset + g),
            F.orig.width,
            F.orig.height,
          );
        }
...
yt.extension = { type: [w.WebGLPipes, w.WebGPUPipes, w.CanvasPipes], name: 'bitmapText' };
function Ve(a, e) {
...
class wt {
  ...
  async _updateGpuText(e) {
    ...
    (t.texturePromise &&
      (this._renderer.htmlText.returnTexturePromise(t.texturePromise), (t.texturePromise = null)),
    ...
    (i && (i.structureDidChange = !0), (t.generatingTexture = !1), me(t, e));
  }
  _getGpuText(e) {
    return e._gpuData[this._renderer.uid] || this.initGpuText(e);
  }
  initGpuText(e) {
    const t = new Ar(this._renderer);
    return (
      (t.renderable = e),
      (t.transform = e.groupTransform),
      (t.texture = M.EMPTY),
...
wt.extension = { type: [w.WebGLPipes, w.WebGPUPipes, w.CanvasPipes], name: 'htmlText' };
function Wr() {
  const { userAgent: a } = E.get().getNavigator();
...
function St(a, e, t, r) {
  ...
  const s = A.getOptimalTexture(i.width, i.height, r, !1);
  return (
...
async function Or(a) {
  const e = a
    .filter((t) => G.has(`${t}-and-url`))
    .map((t) => {
      if (!pe.has(t)) {
        const { entries: r } = G.get(`${t}-and-url`),
          i = [];
        (r.forEach((s) => {
          const n = s.url,
            l = s.faces.map((c) => ({ weight: c.weight, style: c.style }));
          i.push(
            ...l.map((c) => Ir({ fontWeight: c.weight, fontStyle: c.style, fontFamily: t }, n)),
          );
        }),
          pe.set(
            t,
...
function Hr(a, e) {
  const t = X.getOptimalCanvasAndContext(a.width, a.height, e),
    { context: r } = t;
...
class Tt {
  constructor(e) {
    ((this._renderer = e), (this._createCanvas = e.type === be.WEBGPU));
  }
  getTexture(e) {
  ...
  async _buildTexturePromise(e) {
    const { text: t, style: r, resolution: i, textureStyle: s } = e,
      n = te.get(lt),
      o = Dr(t, r),
      l = await Or(o),
      c = or(t, r, l, n),
      u = Math.ceil(Math.ceil(Math.max(1, c.width) + r.padding * 2) * i),
      d = Math.ceil(Math.ceil(Math.max(1, c.height) + r.padding * 2) * i),
      h = n.image,
      f = 2;
    ((h.width = (u | 0) + f), (h.height = (d | 0) + f));
    const x = Er(t, r, i, l, n);
    await Vr(h, x, Wr() && o.length > 0);
    const _ = h;
    let g;
    this._createCanvas && (g = Hr(h, i));
    const p = St(g ? g.canvas : _, h.width - f, h.height - f, i);
    return (
      s && (p.source.style = s),
      this._createCanvas &&
        (this._renderer.texture.initSource(p.source), X.returnCanvasAndContext(g)),
      te.return(n),
      p
    );
  }
...
Tt.extension = { type: [w.WebGLSystem, w.WebGPUSystem, w.CanvasSystem], name: 'htmlText' };
class Yr extends je {
  constructor(e) {
...
vt.extension = { type: [w.WebGLPipes, w.WebGPUPipes, w.CanvasPipes], name: 'text' };
class Ct {
  constructor(e) {
    this._renderer = e;
  }
  getTexture(e, t, r, i) {
    (typeof e == 'string' &&
      ...
      e.textureStyle instanceof $ || (e.textureStyle = new $(e.textureStyle)),
      typeof e.text != 'string' && (e.text = e.text.toString()));
    const { text: s, style: n, textureStyle: o } = e,
      l = e.resolution ?? this._renderer.resolution,
      { frame: c, canvasAndContext: u } = ce.getCanvasAndContext({
        text: s,
        style: n,
        resolution: l,
      }),
      d = St(u.canvas, c.width, c.height, l);
    if (
      (o && (d.source.style = o),
      n.trim && (c.pad(n.padding), d.frame.copyFrom(c), d.frame.scale(1 / l), d.updateUvs()),
      n.filters)
    ) {
      const h = this._applyFilters(d, n.filters);
      return (this.returnTexture(d), ce.returnCanvasAndContext(u), h);
    }
    return (this._renderer.texture.initSource(d._source), ce.returnCanvasAndContext(u), d);
  }
  returnTexture(e) {
    const t = e.source;
    ((t.resource = null),
  ...
  _applyFilters(e, t) {
    const r = this._renderer.renderTarget.renderTarget,
      i = this._renderer.filter.generateFilteredTexture({ texture: e, filters: t });
...
Ct.extension = { type: [w.WebGLSystem, w.WebGPUSystem, w.CanvasSystem], name: 'canvasText' };
C.add(Je);
C.add(Ze);
C.add(ct);
C.add(Ut);
