...
<div style="position:absolute; top:0; left:0; z-index:1000; pointer-events:none;">
  <div style="position:fixed; right:8px; top:8px; background:rgba(0,0,0,.8); color:#fff; padding:12px; border-radius:8px; font:12px system-ui; min-width:200px; pointer-events:auto;">
