...
<div style="position:fixed; inset:0; background: #1a1a2e;">
  ...
  <div style="position:absolute; right:8px; top:8px; background:rgba(0,0,0,.8); color:#fff; padding:12px; border-radius:8px; font:12px system-ui; min-width:200px;">
    ...
    <div style="margin-bottom:8px;">
      ...
      <button on:click={spawnAnimatedDragon} style="margin:2px; padding:6px 12px; background:#2196F3;">Spawn Animated</button>
    </div>
    
    <div style="margin-bottom:8px;">
      <button on:click={startAnimation} style="margin:2px; padding:6px 12px; background:#FF9800;">Start Animation</button>
      <button on:click={stopAnimation} style="margin:2px; padding:6px 12px; background:#9C27B0;">Stop Animation</button>
    </div>
