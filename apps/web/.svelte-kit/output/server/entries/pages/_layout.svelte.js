...
const css = {
  code: ".dev-menu-container.svelte-wtvn00.svelte-wtvn00{position:fixed;top:20px;right:20px;z-index:1000}.dev-menu-toggle.svelte-wtvn00.svelte-wtvn00{background:rgba(0, 0, 0, 0.8);border:1px solid rgba(255, 255, 255, 0.2);border-radius:8px;color:#fff;cursor:pointer;padding:8px;transition:all 0.2s ease;backdrop-filter:blur(10px)}.dev-menu-toggle.svelte-wtvn00.svelte-wtvn00:hover{background:rgba(0, 0, 0, 0.9);border-color:rgba(255, 255, 255, 0.3);transform:scale(1.05)}.dev-menu-toggle.svelte-wtvn00.svelte-wtvn00:active{transform:scale(0.95)}.dev-menu-panel.svelte-wtvn00.svelte-wtvn00{position:absolute;top:100%;right:0;margin-top:8px;background:rgba(0, 0, 0, 0.95);border:1px solid rgba(255, 255, 255, 0.2);border-radius:12px;padding:16px;min-width:200px;backdrop-filter:blur(20px);box-shadow:0 8px 32px rgba(0, 0, 0, 0.3)}.dev-menu-header.svelte-wtvn00.svelte-wtvn00{display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;padding-bottom:12px;border-bottom:1px solid rgba(255, 255, 255, 0.1)}.dev-menu-header.svelte-wtvn00 h3.svelte-wtvn00{margin:0;color:#fff;font-size:14px;font-weight:600}.dev-menu-close.svelte-wtvn00.svelte-wtvn00{background:none;border:none;color:rgba(255, 255, 255, 0.6);cursor:pointer;padding:4px;border-radius:4px;transition:all 0.2s ease}.dev-menu-close.svelte-wtvn00.svelte-wtvn00:hover{color:#fff;background:rgba(255, 255, 255, 0.1)}.dev-menu-nav.svelte-wtvn00.svelte-wtvn00{display:flex;flex-direction:column;gap:8px}.dev-menu-link.svelte-wtvn00.svelte-wtvn00{display:flex;align-items:center;gap:8px;color:rgba(255, 255, 255, 0.8);text-decoration:none;padding:8px 12px;border-radius:6px;transition:all 0.2s ease;font-size:13px}.dev-menu-link.svelte-wtvn00.svelte-wtvn00:hover{color:#fff;background:rgba(255, 255, 255, 0.1);transform:translateX(2px)}.dev-menu-footer.svelte-wtvn00.svelte-wtvn00{margin-top:16px;padding-top:12px;border-top:1px solid rgba(255, 255, 255, 0.1);text-align:center}.dev-menu-footer.svelte-wtvn00 small.svelte-wtvn00{color:rgba(255, 255, 255, 0.5);font-size:11px}@media(max-width: 768px){.dev-menu-container.svelte-wtvn00.svelte-wtvn00{top:10px;right:10px}.dev-menu-panel.svelte-wtvn00.svelte-wtvn00{min-width:180px;padding:12px}}",
  map: null
};
const DevMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$appFlags.devMenu ? `<div class="dev-menu-container svelte-wtvn00"> <button class="dev-menu-toggle svelte-wtvn00" aria-label="Toggle Developer Menu" title="Developer Menu (dev flag enabled)" data-svelte-h="svelte-1l0x6fz"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"></circle><path d="M12 1v6m0 6v6m11-7h-6m-6 0H1"></path></svg></button>  ${``}</div>` : ``}`;
});
