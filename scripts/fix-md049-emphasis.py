...
"""
Fix MD049 violations (emphasis style) - convert underscores to asterisks
"""
...
def fix_md049_emphasis(file_path):
...
if __name__ == "__main__":
    target_file = "docs/optimization/ISSUE_CodeReview_Optimization.md"
    ...
    # Fix the file
    fix_md049_emphasis(target_file)
