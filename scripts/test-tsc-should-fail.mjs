...
const r = spawnSync("pnpm", ["-w", "exec", "tsc", "-p", "tests/ts-strict/tsconfig.strict.should-fail.json", "--pretty", "false"], { encoding: "utf8" });
...
// All assertions passed - strict should-fail test completed successfully
