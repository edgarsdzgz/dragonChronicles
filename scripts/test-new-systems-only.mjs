...
/**
 * Test Script for New Systems Only
 * 
 * This script tests only the newly extracted systems, ignoring
 * the original scrolling-background.ts file.
 */

import { execSync } from 'child_process';
import { readFileSync, existsSync } from 'fs';

console.log('🧪 Testing New Extracted Systems Only...\n');
...
// Test 3: Check linting for new systems only
console.log('Test 3: Checking linting for new systems...');
try {
  // Only lint the new systems directory
  execSync('pnpm exec eslint apps/web/src/lib/pixi/systems --cache --cache-location ./.cache/eslint --max-warnings 0', { stdio: 'pipe' });
  console.log('  ✅ New systems linting passed\n');
} catch (error) {
  console.log('  ❌ New systems linting failed');
  console.log('  Error:', error.message);
  process.exit(1);
}
...
console.log('Test 6: Checking file sizes and complexity...');
systemFiles.forEach(file => {
  if (existsSync(file)) {
...
console.log('Test 7: Checking system exports...');
try {
...
// Summary
console.log('🎉 New Systems Test Summary:');
console.log('  ✅ All new system files created');
console.log('  ✅ TypeScript compilation successful');
console.log('  ✅ New systems linting passed');
...
console.log('');
console.log('✨ Phase 1 new systems are ready for integration!');
