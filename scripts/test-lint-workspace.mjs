...
assert.ok(devDeps["@typescript-eslint/parser"], "@typescript-eslint/parser must be in devDependencies");
assert.ok(devDeps["@typescript-eslint/eslint-plugin"], "@typescript-eslint/eslint-plugin must be in devDependencies");
