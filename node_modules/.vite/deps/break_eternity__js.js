...
var ListNode = _createClass(function ListNode2(key, value) {
...
var f_lambertw = function f_lambertw2(z) {
  ...
  var principal = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var w;
  var wn;
  ...
  _createClass(Decimal2, [{
    ...
    value: function fromString(value) {
        ...
        for (var i = 0; i < newparts[1].length; ++i) {
          ...
          if (chrcode >= 43 && chrcode <= 57 || chrcode === 101) {
            ...
            if (this.layer < 0 || this.layer % 1 != 0) {
              var _result6 = Decimal2.tetrate(10, this.layer, this.mag, linearhyper4);
      ...
      if (!isFinite(mantissa)) {
        ...
        this.layer = ecount;
        if (ecount === 2) {
          var _result7 = Decimal2.mul(FC(1, 2, exponent), D(mantissa));
    ...
    value: function add(value) {
      var decimal = D(value);
      if (this.eq(Decimal2.dInf) && decimal.eq(Decimal2.dNegInf) || this.eq(Decimal2.dNegInf) && decimal.eq(Decimal2.dInf)) {
        return new Decimal2(Decimal2.dNaN);
      }
      if (!Number.isFinite(this.layer)) {
        return new Decimal2(this);
      }
      ...
      if (Decimal2.cmpabs(this, decimal) > 0) {
        a = new Decimal2(this);
        b = new Decimal2(decimal);
      } else {
        a = new Decimal2(decimal);
        b = new Decimal2(this);
      }
    ...
    value: function mul(value) {
      var decimal = D(value);
      if (this.eq(Decimal2.dInf) && decimal.eq(Decimal2.dNegInf) || this.eq(Decimal2.dNegInf) && decimal.eq(Decimal2.dInf)) {
        return new Decimal2(Decimal2.dNegInf);
      }
      if (this.mag == Number.POSITIVE_INFINITY && decimal.eq(Decimal2.dZero) || this.eq(Decimal2.dZero) && this.mag == Number.POSITIVE_INFINITY) {
        return new Decimal2(Decimal2.dNaN);
      }
      if (this.eq(Decimal2.dNegInf) && decimal.eq(Decimal2.dNegInf)) {
        return new Decimal2(Decimal2.dInf);
      }
      if (!Number.isFinite(this.layer)) {
        return new Decimal2(this);
      }
    ...
    value: function mod(value) {
      var floored = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      var vd = D(value);
      var decimal = vd.abs();
      if (this.eq(Decimal2.dZero) || decimal.eq(Decimal2.dZero)) return FC_NN(0, 0, 0);
      if (floored) {
    ...
    value: function max(value) {
      var decimal = D(value);
      return this.lt(decimal) ? new Decimal2(decimal) : new Decimal2(this);
    }
    /**
    ...
    value: function min(value) {
      var decimal = D(value);
      return this.gt(decimal) ? new Decimal2(decimal) : new Decimal2(this);
    }
    /**
    ...
    value: function maxabs(value) {
      var decimal = D(value);
      return this.cmpabs(decimal) < 0 ? new Decimal2(decimal) : new Decimal2(this);
    }
    /**
    ...
    value: function pow(value) {
      var decimal = D(value);
      var a = new Decimal2(this);
      var b = new Decimal2(decimal);
      if (a.sign === 0) {
    ...
    value: function tetrate() {
      ...
      if (height === Number.POSITIVE_INFINITY) {
        ...
        if (this_num <= 1.444667861009766 && this_num >= 0.06598803584531254) {
          ...
          if (this_num > 1.444667861009099) {
            lower = upper = Decimal2.fromNumber(Math.E);
          }
          payload = D(payload);
          if (payload.eq(upper)) return upper;
          else if (payload.lt(upper)) return lower;
          else return new Decimal2(Decimal2.dInf);
      ...
      payload = new Decimal2(payload);
      var oldheight = height;
      height = Math.trunc(height);
      var fracheight = oldheight - height;
      if (this.gt(Decimal2.dZero) && (this.lt(1) || this.lte(1.444667861009766) && payload.lte(Decimal2.ln(this).neg().lambertw(false).div(Decimal2.ln(this).neg()))) && (oldheight > 1e4 || !linear)) {
        var limitheight = Math.min(1e4, height);
        if (payload.eq(Decimal2.dOne)) payload = this.pow(fracheight);
    ...
    value: function slog_internal() {
      ...
      if (base.lt(1.444667861009766)) {
        var negln = Decimal2.ln(base).neg();
        var infTower = negln.lambertw().div(negln);
        if (this.eq(infTower)) return new Decimal2(Decimal2.dInf);
        if (this.gt(infTower)) return new Decimal2(Decimal2.dNaN);
      }
      var result = 0;
      ...
      for (var i = 0; i < 100; ++i) {
        if (copy.lt(Decimal2.dZero)) {
          ...
          if (linear) return Decimal2.fromNumber(result + copy.toNumber() - 1);
          else return Decimal2.fromNumber(result + Decimal2.slog_critical(base.toNumber(), copy.toNumber()));
        } else {
          result += 1;
    ...
    value: function layeradd(diff, base) {
      ...
      if (baseD.gt(1) && baseD.lte(1.444667861009766)) {
        var excessSlog = Decimal2.excess_slog(this, base, linear);
        ...
        return Decimal2.tetrate(baseD, wholeheight, towertop, linear);
      }
    ...
    value: (
      ...
      function lambertw() {
        var principal = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
        if (this.lt(-0.3678794411710499)) {
          return new Decimal2(Decimal2.dNaN);
        } else if (principal) {
          if (this.abs().lt("1e-300")) return new Decimal2(this);
          else if (this.mag < 0) {
          ...
          if (this.layer === 0) {
            return Decimal2.fromNumber(f_lambertw(this.sign * this.mag, 1e-10, false));
          } else if (this.layer == 1) {
    ...
    value: function linear_sroot(degree) {
      ...
      if (this.lte("1ee-16")) {
        if (degree % 2 == 1) return new Decimal2(this);
        else return new Decimal2(Decimal2.dNaN);
      }
      if (this.gt(1)) {
        ...
        while (loopGoing) {
          ...
          if (Decimal2.iteratedexp(10, layer, guess, true).tetrate(degree, 1, true).gt(this)) upper = guess;
          else lower = guess;
        ...
        while (_loopGoing) {
          ...
          if (Decimal2.pow(10, _guess).recip().tetrate(degree, 1, true).gt(this)) _upper = _guess;
          else _lower = _guess;
          if (_guess.eq(_previous)) _loopGoing = false;
          else _previous = _guess;
          if (_upper.gt("1e18")) return new Decimal2(Decimal2.dNaN);
        }
    ...
    value: (
      ...
      function pentate() {
        ...
        var fracheight = oldheight - height;
        var prevpayload = Decimal2.dZero;
        var prevtwopayload = Decimal2.dZero;
        if (fracheight !== 0) {
          if (payload.eq(Decimal2.dOne)) {
            ++height;
    ...
    value: function penta_log() {
      ...
      var iterations = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 100;
      var linear = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
      base = new Decimal2(base);
      if (base.lte(1)) return new Decimal2(Decimal2.dNaN);
      if (this.eq(1)) return FC_NN(0, 0, 0);
      if (this.eq(Decimal2.dInf)) return new Decimal2(Decimal2.dInf);
      var value = new Decimal2(1);
      var result = 0;
      var step_size = 1;
      if (this.lt(-1)) {
        if (this.lte(-2)) return new Decimal2(Decimal2.dNaN);
        var limitcheck = base.tetrate(this.toNumber(), 1, linear);
        if (this.eq(limitcheck)) return new Decimal2(Decimal2.dNegInf);
        if (this.gt(limitcheck)) return new Decimal2(Decimal2.dNaN);
      }
      if (this.gt(1)) {
        while (value.lt(this)) {
          result++;
          value = Decimal2.tetrate(base, value.toNumber(), 1, linear);
          if (result > 1e3) {
            return new Decimal2(Decimal2.dNaN);
          }
        }
        ...
        while (value.gt(this)) {
          result--;
          value = Decimal2.slog(value, base, linear);
          if (result > 100) {
            return new Decimal2(Decimal2.dNaN);
          }
        }
      ...
      for (var i = 1; i < iterations; ++i) {
        var new_decimal = base.pentate(result, Decimal2.dOne, linear);
    ...
    value: function linear_penta_root(degree) {
      ...
      return Decimal2.increasingInverse(function(value) {
        return Decimal2.pentate(value, degree, 1, true);
      })(this);
    }
    // trig functions!
    /**
    ...
    value: function mod(value, other) {
      var floored = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
    ...
    value: function excess_slog(value, base) {
      ...
      var baseD = base;
      base = base.toNumber();
      if (base == 1 || base <= 0) return [new Decimal2(Decimal2.dNaN), 0];
      if (base > 1.444667861009766) return [value.slog(base, 100, linear), 0];
      var negln = Decimal2.ln(base).neg();
      var lower = negln.lambertw().div(negln);
      var upper = Decimal2.dInf;
      ...
      if (value.eq(lower)) return [new Decimal2(Decimal2.dInf), 0];
      if (value.eq(upper)) return [new Decimal2(Decimal2.dNegInf), 2];
      if (value.gt(upper)) {
        ...
        var guess = Decimal2.dZero;
        while (step_size > 1e-16) {
          tested = fracheight + step_size;
          towertop = slogzero.pow(1 - tested).mul(slogone.pow(tested));
          guess = Decimal2.iteratedexp(base, estimate, towertop);
          if (guess.eq(value)) return [new Decimal2(estimate + tested), 2];
          else if (guess.lt(value)) fracheight += step_size;
          step_size /= 2;
        }
        if (guess.neq_tolerance(value, 1e-7)) return [new Decimal2(Decimal2.dNaN), 0];
        return [new Decimal2(estimate + fracheight), 2];
      }
      if (value.lt(upper) && value.gt(lower)) {
        var _slogzero = lower.mul(upper).sqrt();
        var _slogone = baseD.pow(_slogzero);
        var _estimate = 0;
        if (value.lte(_slogzero) && value.gt(_slogone)) _estimate = 0;
        else if (value.lte(_slogone)) {
        ...
        var _guess2 = Decimal2.dZero;
        while (_step_size > 1e-16) {
          _tested = _fracheight + _step_size;
          _towertop = _slogzero.pow(1 - _tested).mul(_slogone.pow(_tested));
          _guess2 = Decimal2.iteratedexp(base, _estimate, _towertop);
          if (_guess2.eq(value)) return [new Decimal2(_estimate + _tested), 1];
          else if (_guess2.gt(value)) _fracheight += _step_size;
          _step_size /= 2;
        }
        if (_guess2.neq_tolerance(value, 1e-7)) return [new Decimal2(Decimal2.dNaN), 0];
        return [new Decimal2(_estimate + _fracheight), 1];
      }
    ...
    value: function increasingInverse(func) {
      var decreasing = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      var iterations = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 120;
      var minX = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : Decimal2.dLayerMax.neg();
      var maxX = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : Decimal2.dLayerMax;
      var minY = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : Decimal2.dLayerMax.neg();
      var maxY = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : Decimal2.dLayerMax;
      return function(value) {
        value = new Decimal2(value);
        minX = new Decimal2(minX);
        maxX = new Decimal2(maxX);
        minY = new Decimal2(minY);
        maxY = new Decimal2(maxY);
        if (value.isNan() || maxX.lt(minX) || value.lt(minY) || value.gt(maxY)) return new Decimal2(Decimal2.dNaN);
        var rangeApply = function rangeApply2(value2) {
        ...
        if (maxX.lt(0)) currentCheck = false;
          ...
          var valCheck = func(Decimal2.dZero);
        ...
        if (currentCheck) {
          if (maxX.lt(FIRST_NEG_LAYER)) currentCheck = true;
            ...
            var _valCheck = func(new Decimal2(FIRST_NEG_LAYER));
            currentCheck = value.lt(_valCheck);
            if (decreasing) currentCheck = !currentCheck;
          }
          if (currentCheck) {
            reciprocal = true;
            var limit = Decimal2.pow(10, EXP_LIMIT).recip();
            if (maxX.lt(limit)) currentCheck = false;
            else if (minX.gt(limit)) currentCheck = true;
            else {
              var _valCheck2 = func(new Decimal2(limit));
              currentCheck = value.gt(_valCheck2);
              if (decreasing) currentCheck = !currentCheck;
            }
            if (currentCheck) rangeApply = function rangeApply2(value2) {
              return Decimal2.pow(10, value2).recip();
            };
            else {
              var _limit = Decimal2.tetrate(10, EXP_LIMIT);
              if (maxX.lt(_limit)) currentCheck = false;
              else if (minX.gt(_limit)) currentCheck = true;
              else {
                var _valCheck3 = func(new Decimal2(_limit));
                currentCheck = value.gt(_valCheck3);
                if (decreasing) currentCheck = !currentCheck;
              }
              if (currentCheck) rangeApply = function rangeApply2(value2) {
                return Decimal2.tetrate(10, new Decimal2(value2).toNumber()).recip();
              };
              else rangeApply = function rangeApply2(value2) {
                return new Decimal2(value2).gt(Math.log10(Number.MAX_VALUE)) ? Decimal2.dZero : Decimal2.tetrate(10, Decimal2.pow(10, value2).toNumber()).recip();
              };
            }
          } else {
            reciprocal = false;
            if (maxX.lt(EXP_LIMIT)) currentCheck = true;
              ...
              var _valCheck4 = func(new Decimal2(EXP_LIMIT));
            ...
            if (currentCheck) rangeApply = function rangeApply2(value2) {
              ...
              var _limit2 = Decimal2.pow(10, EXP_LIMIT);
              if (maxX.lt(_limit2)) currentCheck = true;
              else if (minX.gt(_limit2)) currentCheck = false;
              else {
                var _valCheck5 = func(new Decimal2(_limit2));
                currentCheck = value.lt(_valCheck5);
                if (decreasing) currentCheck = !currentCheck;
              }
              if (currentCheck) rangeApply = function rangeApply2(value2) {
                return Decimal2.pow(10, value2);
              };
              else {
                var _limit3 = Decimal2.tetrate(10, EXP_LIMIT);
                if (maxX.lt(_limit3)) currentCheck = true;
                else if (minX.gt(_limit3)) currentCheck = false;
                else {
                  var _valCheck6 = func(new Decimal2(_limit3));
                  currentCheck = value.lt(_valCheck6);
                  if (decreasing) currentCheck = !currentCheck;
                }
                if (currentCheck) rangeApply = function rangeApply2(value2) {
                  return Decimal2.tetrate(10, new Decimal2(value2).toNumber());
                };
                else rangeApply = function rangeApply2(value2) {
                  return new Decimal2(value2).gt(Math.log10(Number.MAX_VALUE)) ? Decimal2.dInf : Decimal2.tetrate(10, Decimal2.pow(10, value2).toNumber());
                };
              }
            }
          }
          ...
          if (maxX.lt(-FIRST_NEG_LAYER)) currentCheck = false;
            ...
            var _valCheck7 = func(new Decimal2(-FIRST_NEG_LAYER));
            currentCheck = value.gt(_valCheck7);
            if (decreasing) currentCheck = !currentCheck;
          }
          if (currentCheck) {
            var _limit4 = Decimal2.pow(10, EXP_LIMIT).recip().neg();
            if (maxX.lt(_limit4)) currentCheck = true;
            else if (minX.gt(_limit4)) currentCheck = false;
            else {
              var _valCheck8 = func(new Decimal2(_limit4));
              currentCheck = value.lt(_valCheck8);
              if (decreasing) currentCheck = !currentCheck;
            }
            if (currentCheck) rangeApply = function rangeApply2(value2) {
              return Decimal2.pow(10, value2).recip().neg();
            };
            else {
              var _limit5 = Decimal2.tetrate(10, EXP_LIMIT).neg();
              if (maxX.lt(_limit5)) currentCheck = true;
              else if (minX.gt(_limit5)) currentCheck = false;
              else {
                var _valCheck9 = func(new Decimal2(_limit5));
                currentCheck = value.lt(_valCheck9);
                if (decreasing) currentCheck = !currentCheck;
              }
              if (currentCheck) rangeApply = function rangeApply2(value2) {
                return Decimal2.tetrate(10, new Decimal2(value2).toNumber()).recip().neg();
              };
              else rangeApply = function rangeApply2(value2) {
                return new Decimal2(value2).gt(Math.log10(Number.MAX_VALUE)) ? Decimal2.dZero : Decimal2.tetrate(10, Decimal2.pow(10, value2).toNumber()).recip().neg();
              };
            }
          } else {
            reciprocal = false;
            if (maxX.lt(-EXP_LIMIT)) currentCheck = false;
              ...
              var _valCheck10 = func(new Decimal2(-EXP_LIMIT));
              currentCheck = value.gt(_valCheck10);
              if (decreasing) currentCheck = !currentCheck;
            }
            if (currentCheck) rangeApply = function rangeApply2(value2) {
              return Decimal2.neg(value2);
            };
            else {
              var _limit6 = Decimal2.pow(10, EXP_LIMIT).neg();
              if (maxX.lt(_limit6)) currentCheck = false;
              else if (minX.gt(_limit6)) currentCheck = true;
              else {
                var _valCheck11 = func(new Decimal2(_limit6));
                currentCheck = value.gt(_valCheck11);
                if (decreasing) currentCheck = !currentCheck;
              }
              if (currentCheck) rangeApply = function rangeApply2(value2) {
                return Decimal2.pow(10, value2).neg();
              };
              else {
                var _limit7 = Decimal2.tetrate(10, EXP_LIMIT).neg();
                if (maxX.lt(_limit7)) currentCheck = false;
                else if (minX.gt(_limit7)) currentCheck = true;
                else {
                  var _valCheck12 = func(new Decimal2(_limit7));
                  currentCheck = value.gt(_valCheck12);
                  if (decreasing) currentCheck = !currentCheck;
                }
                if (currentCheck) rangeApply = function rangeApply2(value2) {
                  return Decimal2.tetrate(10, new Decimal2(value2).toNumber()).neg();
                };
                else rangeApply = function rangeApply2(value2) {
                  return new Decimal2(value2).gt(Math.log10(Number.MAX_VALUE)) ? Decimal2.dNegInf : Decimal2.tetrate(10, Decimal2.pow(10, value2).toNumber()).neg();
                };
              }
            }
          }
        ...
        var comparative = searchIncreasing ? function(a, b) {
          return Decimal2.gt(a, b);
        } : function(a, b) {
          return Decimal2.lt(a, b);
        };
        var step_size = 1e-3;
        var has_changed_directions_once = false;
        var previously_rose = false;
        var result = 1;
        var appliedResult = Decimal2.dOne;
        var oldresult = 0;
        var critical = false;
        for (var i = 1; i < iterations; ++i) {
          critical = false;
          ...
          if (currently_rose != searchIncreasing && appliedResult.eq(maxX) || currently_rose == searchIncreasing && appliedResult.eq(minX)) return new Decimal2(Decimal2.dNaN);
          step_size = Math.abs(step_size) * (currently_rose ? -1 : 1);
          result += step_size;
...
//# sourceMappingURL=break_eternity__js.js.map
