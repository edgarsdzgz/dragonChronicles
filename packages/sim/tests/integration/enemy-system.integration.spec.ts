...
describe('Enemy System Integration', () => {
  ...
  describe('Pool Manager and Enemy Pool Integration', () => {
    ...
    it('should handle multiple enemy families through integration', () => {
      ...
      const meleeEnemy = poolManager.spawnEnemy(
        1 as Family,
        { x: 0, y: 0 },
        1 as WardId,
        1 as LandId,
      ...
      const meleeEnemies = poolManager.getActiveEnemiesByFamily(1 as Family);
      const rangedEnemies = poolManager.getActiveEnemiesByFamily(2 as Family);
    ...
    it('should handle spatial queries through integration', () => {
      ...
      const closeEnemy = poolManager.spawnEnemy(
        1 as Family,
        { x: 60, y: 60 },
        1 as WardId,
        1 as LandId,
  ...
  describe('Error Handling Integration', () => {
    it('should handle invalid configuration gracefully', () => {
      ...
      const enemyConfig = getEnemyConfig(spawnConfig, invalidWardId, 1 as Family);
    ...
    it('should handle pool exhaustion gracefully', () => {
      ...
      const enemy = poolManager.spawnEnemy(
        1 as Family,
        { x: 0, y: 0 },
        1 as WardId,
        1 as LandId,
