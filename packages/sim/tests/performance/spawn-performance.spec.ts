...
describe('Spawn System Performance', () => {
  ...
  describe('Spawn Performance', () => {
    it('should spawn 100 enemies within performance budget', () => {
      ...
      console.log(
        `Performance: ${duration.toFixed(2)}ms for 100 spawns (${(duration / 100).toFixed(3)}ms per spawn)`,
      );
    });
    ...
    it('should handle high-frequency updates efficiently', () => {
      ...
      console.log(
        `Performance: ${duration.toFixed(2)}ms for 1000 updates (${(duration / 1000).toFixed(3)}ms per update)`,
      );
    });
    ...
    it('should maintain performance with large enemy counts', () => {
      ...
      console.log(
        `Performance: ${duration.toFixed(2)}ms for ${maxEnemies} spawns (${(duration / maxEnemies).toFixed(3)}ms per spawn)`,
      );
    });
