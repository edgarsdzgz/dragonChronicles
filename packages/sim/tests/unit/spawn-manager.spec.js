...
import { SpawnManager, DEFAULT_SPAWN_MANAGER_CONFIG, } from '../../src/enemies/spawn-manager.js';
    ...
    describe('Enemy Spawning', () => {
        ...
        it('should spawn enemies at appropriate distances from player', () => {
            ...
            for (const enemy of activeEnemies) {
                const distance = Math.sqrt(Math.pow(enemy.position.x - playerPosition.x, 2) +
