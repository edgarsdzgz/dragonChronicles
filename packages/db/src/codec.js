 ...
 */
export function generateChecksumSync(data) {
    try {
 ...
 */
export async function validateChecksum(data, expectedChecksum) {
    try {
 ...
 */
export async function encodeExportV1(saveData) {
    try {
        // Validate save data (use ExportDataV1 validation for empty profiles)
        const validatedData = saveData.profiles.length === 0 ? validateExportDataV1(saveData) : validateSaveV1(saveData);
 ...
 */
export async function validateExportV1(exportData) {
    try {
 ...
 */
export function deserializeSaveData(jsonString) {
    try {
 ...
 * @returns JSON string representation
 */
export function serializeExportFile(exportData) {
    try {
 ...
 */
export function deserializeExportFile(jsonString) {
    try {
        const parsed = JSON.parse(jsonString);
 ...
 */
export function exportFileToBlob(exportData) {
    try {
 ...
 * @returns Parsed and validated export file
 */
export async function blobToExportFile(blob) {
    try {
