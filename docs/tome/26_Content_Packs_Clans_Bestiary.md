...
**Faction Lore**: Survivors and descendants of the Pyrean Commonwealth who embraced the
corruption rather than fled. Their philosophy: "We tried to control fire. We should have
**become** fire." Through ritual self-immolation, they remain burned but alive, powered by
corrupted flame. They seek to "complete" the Flame-Ward by spreading the gift of eternal
fire to Draconia itself.

**Leadership**: The Forge-Master of the Inferno (former Pyrean Archmage who built the
Crucible Engine, survived the Combustion, now believes he achieved transcendence). Ember
Prophets channel the Crucible Engine's corrupted energy. Ashen Converts are recent recruits
drawn by promises of "fire that never dies."
...
export const FLAME*TOUCHED*CULTISTS = {
  ...
  origin: 'Pyrean Commonwealth survivors who embraced corruption as transcendence',
  ...
  arcanaFlavor: 'Molten memories and ember-touched souls - fragments of Pyrean civilization',
  ...
  heatSystem: {
    ...
    loreReason: 'The land itself remembers being burned in the Combustion'
  },

  // Volcanic Hazards
  hazards: [
    'Lava flows that deal continuous damage (former agricultural terraces)',
    'Volcanic vents that erupt periodically (corrupted geothermal power sources)',
    'Heat waves that reduce visibility',
    'Ember storms that spread fire damage (echoes of the Cataclysm)'
  ],

  // Environmental Storytelling Elements
  environmentalDetails: [
    'Melted Drake-Rider statues frozen mid-flight',
    'Kiln-forges with half-finished ceramics fused to volcanic glass',
    'Road signs pointing to cities that no longer exist',
    'Cultist camps built in ruins of Pyrean family homes',
    'Lesser Drakes (now Ember Wraiths) still guarding bonded locations',
    'The eternal flame at Mount Ashencrown visible on the horizon'
  ]
};
