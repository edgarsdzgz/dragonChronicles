...
### Objective
Lock shared contracts (Sim↔UI), timing model, and deterministic RNG so every later system (spawns, collisions, economy) is reproducible, testable, and fast.
...
- [ ] Add comprehensive test coverage (95%+ for sim/*, 100% for shared/*)
